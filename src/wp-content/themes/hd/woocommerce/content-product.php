...
?>
<div <?php wc_product_class( 'cell item', $product ); ?>>
	<?php
	/**
	 * Hook: woocommerce_before_shop_loop_item.
	 *
	 * @see woocommerce_template_loop_product_link_open - 10 - REMOVED
	 */
	 ...
	 *
	 * @see woocommerce_show_product_loop_sale_flash - 10 - REMOVED
