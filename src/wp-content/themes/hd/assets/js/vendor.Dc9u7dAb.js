...
const e$9 = function(e2) {
  ...
  return !t2 || t2 === document.body || o2 && t2 === o2 ? null : e$9(t2) ? t2 : n$8(t2.parentElement, o2);
};
...
const f = (e2, t2) => {
  let f2, h2, v2, p2 = Object.assign(Object.assign({}, u$2), t2), g = [], m2 = [], E2 = [], w2 = false, y2 = false, T = false, b2 = false, M2 = 0, x2 = 0, L = 0, P = 0, D2 = 0, X = 0, Y = 0, j2 = 0, k2 = 0, R2 = [], z2 = 0, A2 = 0;
  ...
  function C(e3) {
    ...
    e3 instanceof MouseEvent && (window.addEventListener("mousemove", I2), window.addEventListener("mouseup", B2)), window.addEventListener("blur", F), f2 = e3, m2 = o$6(e3), g = [...m2], E2 = [], x2 = m2.length, h2 = i$6(m2), 1 === x2 && (w2 = false, y2 = false, T = false), x2 && q2(i$6(m2));
  ...
  function I2(e3) {
    ...
    w2 || (w2 = Math.abs(D2) > p2.panThreshold || Math.abs(X) > p2.panThreshold, w2 && (d$1 = false, clearTimeout(A2), A2 = 0, k2 = Math.abs(180 * Math.atan2(X, D2) / Math.PI), v2 = k2 > 45 && k2 < 135 ? "y" : "x", g = [...m2], E2 = [...m2], D2 = 0, X = 0, L = 0, P = 0, null === (t3 = window.getSelection()) || void 0 === t3 || t3.removeAllRanges(), S("panstart"))), w2 && (L || P) && S("pan"), S("move");
  }
  function B2(e3) {
  ...
  function G() {
    l$6 = false, w2 = false, y2 = false, b2 = false, x2 = 0, R2 = [], m2 = [], E2 = [], g = [], L = 0, P = 0, D2 = 0, X = 0, Y = 0, j2 = 0, k2 = 0, v2 = void 0, window.removeEventListener("mousemove", I2), window.removeEventListener("mouseup", B2), window.removeEventListener("blur", F), d$1 || A2 || (A2 = setTimeout((() => {
      d$1 = true, A2 = 0;
    }), 100));
  }
  function H2(e3) {
    const t3 = e3.target;
    l$6 = false, t3 && !e3.defaultPrevented && (d$1 || (r$4(e3), e3.stopPropagation()));
  }
  const J = { init: function() {
    ...
    clearTimeout(z2), clearTimeout(A2), A2 = 0, e2 && (e2.removeEventListener("click", H2, a$5), e2.removeEventListener("mousedown", C, a$5), e2.removeEventListener("touchstart", C, a$5), e2.removeEventListener("touchmove", I2, a$5), e2.removeEventListener("touchend", B2), e2.removeEventListener("touchcancel", B2)), e2 = null, G();
  } };
  return J;
};
...
const E$1 = (c2, b2 = {}, E2 = {}) => {
  let S, O2, C, T, A2, F, Z, L, P = 0, X = Object.assign(Object.assign({}, x), b2), Y = {}, R2 = Object.assign({}, y$1), z2 = Object.assign({}, y$1);
  const D2 = [];
  function I2(e2) {
    let t2 = X[e2];
  ...
  function V() {
    ...
    p(O2) && (O2.setAttribute("width", e2 + ""), O2.setAttribute("height", t2 + "")), S && (s$6(S, "has-error"), p(O2) && (S.setAttribute("width", e2 + ""), S.setAttribute("height", t2 + ""), S.style.aspectRatio = `${e2 / t2 || ""}`)), F = c$3().on("start", ((e3, t3) => {
      ...
      (null == A2 ? void 0 : A2.isPointerDown()) || le(), (null == F ? void 0 : F.isRunning()) || (ce(), H2("animationEnd"));
    })), (function() {
      const e3 = I2("gestures");
      if (!e3) return;
      if (!T || !O2) return;
      let t3 = false;
      A2 = f(T, e3).on("start", ((e4) => {
  ...
  function ye() {
    return !(!W() || !(null == A2 ? void 0 : A2.isPointerDown()) || Q());
  }
  function xe() {
  ...
  const je = { canDrag: be, canZoomIn: pe, canZoomOut: me, canZoomToFull: ve, destroy: function() {
    ...
    return S && (S.style.aspectRatio = "", S.style.maxWidth = "", S.style.maxHeight = ""), T && (T.style.width = "", T.style.height = "", T.style.transform = ""), S = void 0, O2 = void 0, T = void 0, R2 = Object.assign({}, y$1), z2 = Object.assign({}, y$1), null == F || F.destroy(), F = void 0, null == A2 || A2.destroy(), A2 = void 0, P = 4, je;
    ...
    return je;
  }, toggleFS: Me, updateControls: ce, version: "6.1.4", willZoomIn: ge, willZoomOut: he };
  return je;
};
...
const E = (g, x2 = {}, w2 = {}) => {
  y++;
  let M2, S, j2, A2, L, P = 0, T = Object.assign({}, h), O2 = Object.assign({}, h), R2 = {}, C = null, V = null, H2 = false, D2 = false, $2 = false, q2 = false, I2 = "height", F = 0, z2 = true, k2 = 0, B2 = 0, N2 = 0, _2 = 0, G = "*", X = [], Y = [];
  ...
  function ot() {
    ...
    if (void 0 === L || r2 !== L) {
      ...
      Vt(), O2 = i2, false !== tt("enabled") && (P = 0, it("init"), (function() {
        ...
        s$7(C, e3.container);
        const n3 = tt("style");
        if (n3 && t$5(n3)) for (const [t2, e4] of Object.entries(n3)) C.style.setProperty(t2, e4);
        V = C.querySelector(`.${e3.viewport}`), V || (V = document.createElement("div"), s$7(V, e3.viewport), V.append(...e$3(C, `.${e3.slide}`)), C.insertAdjacentElement("afterbegin", V)), C.carousel = $t, it("initLayout");
      })(), (function() {
        if (!V) return;
        const t2 = tt("classes") || {};
        X = [], [...e$3(V, `.${t2.slide}`)].forEach(((t3) => {
          if (t3.parentElement) {
        ...
        for (const t3 of X) {
          const e3 = t3.el;
          (null == e3 ? void 0 : e3.parentElement) === V && (s$7(e3, O2.classes.slide), s$7(e3, t3.class), Tt(t3), it("attachSlideEl", t3));
        }
        it("initSlides");
      })(), wt(), P = 1, s$7(C, (tt("classes") || {}).isEnabled || ""), Ct(), ct(), S = c$3().on("start", (() => {
        M2 && M2.isPointerDown() || (at(), Ct());
      })).on("step", ((t2) => {
        const e3 = F;
        F = t2.pos, F !== e3 && (z2 = false, Ct());
      })).on("end", ((t2) => {
        ...
        if (!C || !V) return;
        C.addEventListener("click", At, { passive: false }), document.addEventListener("mousemove", st);
        ...
        if (Q = t2.height, U = t2.width, !j2) {
          ...
          j2 = new ResizeObserver((() => {
            t3 || (t3 = requestAnimationFrame((() => {
              !(function() {
                if (1 !== P || !V) return;
                const t4 = K.length, e3 = V.getBoundingClientRect(), n3 = e3.height, i3 = e3.width;
                t4 > 1 && (q2 && Math.abs(n3 - Q) < 0.5 || !q2 && Math.abs(i3 - U) < 0.5) || (wt(), rt(), Q = n3, U = i3, q2 && !n3 || !q2 && !i3 || C && V && (t4 === K.length && (null == M2 ? void 0 : M2.isPointerDown()) || (tt("dragFree") && (D2 || F > N2 && F < _2) ? (at(), Ct()) : Ot(k2, { transition: false }))));
              })(), t3 = null;
            })));
          })), j2.observe(V);
        }
  ...
  function rt() {
    false === tt("gestures") ? M2 && (M2.destroy(), M2 = void 0) : M2 || (function() {
      ...
      !M2 && false !== t2 && V && (M2 = f(V, t2).on("start", ((t3) => {
        var e2, n2;
        if (!S) return;
        const { srcEvent: o2 } = t3;
        q2 && e$5(o2) && !n$8(o2.target) && m(o2), S.pause(), S.getCurrentVelocities().pos = 0;
        ...
        })(s2.el)[I2] || 0) * ($2 && !q2 ? 1 : -1)), St(), D2 || (F < N2 || F > _2) && S.spring({ clamp: true, mass: 1, tension: 500, friction: 25, velocity: (null === (n2 = S.getCurrentVelocities()) || void 0 === n2 ? void 0 : n2.pos) || 0, restDelta: 1, restSpeed: 1 }).from({ pos: F }).to({ pos: t$6(N2, F, _2) }).start();
      })).on("move", ((t3) => {
        var e2, n2;
        ...
        if (u2 || (m2 += g2 * (v2 ? 5 : 1) * h2), !D2 && (g2 * h2 <= 0 && m2 < N2 || g2 * h2 >= 0 && m2 > _2)) {
          let t4 = 0;
          return Math.abs(g2) > 0 && (t4 = 2 * Math.abs(g2), t4 = Math.min(0.3 * vt(), t4)), m2 = t$6(N2 + -1 * t4, m2, _2 + t4), void S.spring({ clamp: true, mass: 1, tension: 380, friction: 25, velocity: -1 * g2, restDelta: 1, restSpeed: 1 }).from({ pos: F }).to({ pos: m2 }).start();
        }
    ...
    })(), s$5(V, "is-draggable", !!M2 && K.length > 0);
  }
  function lt(t2 = "*") {
    var e2;
    const n2 = [];
  ...
  function ct() {
    var t2, e2;
    if (!C) return;
    for (const t3 of C.querySelectorAll("[data-carousel-index]")) t3.innerHTML = k2 + "";
    for (const t3 of C.querySelectorAll("[data-carousel-page]")) t3.innerHTML = k2 + 1 + "";
    for (const t3 of C.querySelectorAll("[data-carousel-pages]")) t3.innerHTML = K.length + "";
    for (const e3 of C.querySelectorAll("[data-carousel-go-to]")) {
    ...
    for (const t3 of C.querySelectorAll("[data-carousel-go-prev]")) t3.toggleAttribute("aria-disabled", !Ht()), Ht() ? t3.removeAttribute("tabindex") : t3.setAttribute("tabindex", "-1");
    for (const t3 of C.querySelectorAll("[data-carousel-go-next]")) t3.toggleAttribute("aria-disabled", !Dt()), Dt() ? t3.removeAttribute("tabindex") : t3.setAttribute("tabindex", "-1");
    let n2 = false;
    const i2 = null === (e2 = K[k2]) || void 0 === e2 ? void 0 : e2.slides[0];
    i2 && (i2.downloadSrc || "image" === i2.type && i2.src) && (n2 = true);
    for (const t3 of C.querySelectorAll("[data-carousel-download]")) t3.toggleAttribute("aria-disabled", !n2);
  }
  function dt(t2) {
    var e2;
  ...
  function vt() {
    let t2 = 0;
    return V && (V.childElementCount || (V.style.display = "grid"), t2 = V.getBoundingClientRect()[I2] || 0, V.style.display = ""), t2;
  }
  function pt(t2 = true) {
  ...
  function yt(t2) {
    ...
    if (e2) {
      if (e2.setAttribute("index", t2.index + ""), e2.parentElement !== V) {
        ...
        V.insertBefore(e2, n2 && V.contains(n2) ? n2 : null), it("attachSlideEl", t2);
      }
      return dt(t2), e2;
    }
  }
  ...
  function wt() {
    ...
    const r2 = tt("classes");
    if (s$5(C, r2.isLTR, !$2), s$5(C, r2.isRTL, $2), s$5(C, r2.isHorizontal, !q2), s$5(C, r2.isVertical, q2), s$5(C, r2.hasAdaptiveHeight, tt("adaptiveHeight")), !vt()) return;
    const l2 = window.getComputedStyle(V);
    H2 = "visible" === l2.getPropertyValue("overflow-" + (q2 ? "y" : "x")), Z = V && parseFloat(l2.getPropertyValue("--f-carousel-gap")) || 0;
    const d2 = (function() {
      let t3 = 0;
      if (V) {
        let e2 = document.createElement("div");
        e2.style.display = "block", s$7(e2, O2.classes.slide), V.appendChild(e2), t3 = e2.getBoundingClientRect()[I2], e2.remove(), e2 = void 0;
      }
      return t3;
    })();
    for (const n3 of Y) {
      ...
      if (!n3.isVirtual && i3 && n$9(i3)) {
        let e2 = false;
        i3.parentElement && i3.parentElement === V || (V.appendChild(i3), e2 = true), o3 = i3.getBoundingClientRect()[I2], e2 && (null === (t2 = i3.parentElement) || void 0 === t2 || t2.removeChild(i3));
      } else o3 = d2;
      n3.dim = o3;
    }
    if (D2 = false, tt("infinite")) {
      ...
      let e2 = vt();
      if (H2) {
        const t4 = V.getBoundingClientRect();
  ...
  function jt(t2) {
    var e2;
    "f-" === (null === (e2 = t2.animationName) || void 0 === e2 ? void 0 : e2.substring(0, 2)) && (Mt(t2.target), W.size || (s$6(C, "in-transition"), !z2 && Math.abs($t.getPosition(true) - B2) < 0.5 && (z2 = true, it("settle"))), Ct());
  }
  function At(t2) {
    var e2;
  ...
  function Ot(e2, i2 = {}) {
    ...
    if ((function(t2, e3) {
      var i3, o3, s2, r3;
      if (!(C && S && e3 && t$7(e3) && "tween" !== e3)) return false;
      ...
      z2 = false, S.pause(), St(), s$7(C, "in-transition"), F = B2 = m2;
      const h2 = yt(f3), b2 = yt(p3);
      return at(), h2 && (W.add(v3), h2.style.transform = "", h2.addEventListener("animationend", jt), s$6(h2, O2.classes.isSelected), h2.inert = false, s$7(h2, `f-${e3}Out to-${u3 > 0 ? "next" : "prev"}`)), b2 && (W.add(g2), b2.style.transform = "", b2.addEventListener("animationend", jt), s$7(b2, O2.classes.isSelected), b2.inert = false, s$7(b2, `f-${e3}In from-${u3 > 0 ? "prev" : "next"}`)), Ct(), true;
    })(e2, l2)) return;
    ...
    if (Math.abs(B2 - p2) < 1) return F = B2, k2 !== e2 && (Tt(), A2 = k2, k2 = e2, ct(), dt(), it("change", k2, A2)), Ct(), void (z2 || (z2 = true, it("settle")));
    if (S.pause(), St(), D2) {
    ...
    false !== l2 && t$5(u2) ? S.spring(r$3({}, O2.tween, u2)).from({ pos: F }).to({ pos: B2 }).start() : (F = B2, at(), Ct(), z2 || (z2 = true, it("settle")));
  }
  function Rt(t2) {
    var e2;
    let n2 = F;
  ...
  function Vt() {
    null == C || C.removeEventListener("click", At), document.removeEventListener("mousemove", st), W.clear(), null == j2 || j2.disconnect(), j2 = void 0;
    for (const t2 of X) {
      let n2 = t2.el;
      n2 && n$9(n2) && (t2.state = void 0, Lt(t2), Pt(t2), t2.isVirtual ? (Et(t2), t2.el = void 0) : (Mt(n2), n2.style.transform = "", V && !V.contains(n2) && V.appendChild(n2)));
    }
    for (const t2 of Object.values(R2)) null == t2 || t2.destroy();
    R2 = {}, null == M2 || M2.destroy(), M2 = void 0, null == S || S.destroy(), S = void 0;
    for (const [t2, e2] of Object.entries(O2.classes || {})) "container" !== t2 && s$6(C, e2);
    s$6(V, "is-draggable");
  }
  function Ht() {
    return D2 || k2 > 0;
  ...
  const $t = { add: function(t2, e2) {
    ...
    return mt(t2, e2), lt(G), wt(), S && s2 && (o2 === k2 && (i2 -= l2 * s2), i2 === B2 ? F = B2 : S.spring({ clamp: true, mass: 1, tension: 300, friction: 25, restDelta: 1, restSpeed: 1 }).from({ pos: i2 }).to({ pos: B2 }).start()), Ct(), $t;
  }, canGoPrev: Ht, canGoNext: Dt, destroy: function() {
    return it("destroy"), window.removeEventListener("resize", ot), Vt(), nt.clear(), C = null, K = [], X = [], O2 = Object.assign({}, h), R2 = {}, Y = [], L = void 0, G = "*", P = 2, $t;
  }, emit: it, filter: function(t2 = "*") {
    return lt(t2), wt(), F = t$6(N2, F, _2), Ct(), it("filter", t2), $t;
    ...
    return 0 !== P && (Vt(), P = 0), C = g, T = x2, window.removeEventListener("resize", ot), T.breakpoints && window.addEventListener("resize", ot), ot(), $t;
  }, isInfinite: function() {
    return D2;
    ...
    return Vt(), P = 0, L = void 0, G = "*", x2 = t2, T = t2, w2 = e2, ot(), $t;
  }, remove: function(t2) {
    void 0 === t2 && (t2 = X.length - 1);
    const e2 = X[t2];
    return e2 && (it("removeSlide", e2), e2.el && (Mt(e2.el), e2.el.remove(), e2.el = void 0), X.splice(t2, 1), lt(G), wt(), F = t$6(N2, F, _2), Ct()), $t;
...
let e, n, o$1 = false, r = false, i = false;
const l = () => {
  ...
  o2 && e.fromTriggerEl(o2), s() || (o2 = document.querySelectorAll(`[data-fancybox="${t2}"]`)[n2 - 1], o2 && e.fromTriggerEl(o2, { startIndex: n2 - 1 })), s() && o2 && !o2.closest("[inert]") && o2.scrollIntoView({ behavior: "instant", block: "center", inline: "center" });
}, u = () => {
  if (!e) return;
  if (r) return;
  const t2 = null == e ? void 0 : e.getInstance(), n2 = null == t2 ? void 0 : t2.getCarousel();
  if (false === (null == t2 ? void 0 : t2.getOptions().Hash)) return;
  const { urlSlug: s2, urlIndex: u2 } = l();
  if (t2 && n2) {
    const e2 = n2.getSlides();
    for (const t3 of e2 || []) if (s2 === t3.slug || s2 === t3.fancybox && t3.index === u2 - 1) return o$1 = false, void n2.goTo(t3.index);
  ...
  e && (n = setTimeout((() => {
    a();
  }), 300), window.addEventListener("hashchange", u, false));
}, d = () => {
  let t2, e2 = "auto", s2 = "";
  function a2() {
    var n2, r2;
    ...
    if (!i2) return;
    const { urlHash: a3, urlSlug: c3 } = l(), d2 = t2.getSlide();
    if (!d2) return;
    let f2 = d2.slug || d2.fancybox || "", g = parseInt(d2.index + "", 10) + 1;
    if (!f2) return;
    let h2 = d2.slug ? `#${d2.slug}` : `#${f2}-${g}`;
    ((null === (r2 = null === (n2 = t2.getCarousel()) || void 0 === n2 ? void 0 : n2.getPages()) || void 0 === r2 ? void 0 : r2.length) || 0) < 2 && (h2 = `#${f2}`), a3 !== h2 && (s2 = a3), history.scrollRestoration && (e2 = history.scrollRestoration, history.scrollRestoration = "manual"), i2.on("change", u2);
    const w2 = f2 !== c3;
    try {
      window.history[w2 ? "pushState" : "replaceState"]({}, document.title, window.location.pathname + window.location.search + h2), w2 && (o$1 = true);
    } catch (t3) {
    }
  }
  function u2() {
  ...
  function c2() {
    ...
    if (e3.fancybox || "") {
      ...
      try {
        ...
        })() ? window.history.back() : window.history.replaceState({}, document.title, window.location.pathname + window.location.search + s2);
      } catch (t3) {
      }
      r = false;
    }
  ...
  return { init: function(e3) {
    clearTimeout(n), t2 = e3, t2.on("ready", a2), t2.on("close", c2);
  }, destroy: function() {
...
d.startFromUrl = a, d.setup = function(n2) {
  e || (e = n2, e$2() && (/complete|interactive|loaded/.test(document.readyState) ? c() : document.addEventListener("DOMContentLoaded", c)));
};
...
const D = "with-fancybox", B = () => {
  ...
  function Ae(e2, t2) {
    ...
    te("close", e2), Y = false, document.body.removeEventListener("click", pe), document.body.removeEventListener("keydown", ge, { passive: false, capture: true }), J("placeFocusBack") && Te(), J("fadeEffect") && (null == T || T.classList.remove("is-ready"), null == T || T.classList.add("is-hiding")), null == T || T.classList.add("is-closing");
    ...
    if (B2 && i2 && s2 && l2 && r3) {
      ...
      if (J("zoomEffect") && 1 === i2.state && (e3 = we(i2)), e3) {
        c2 = true;
        const t3 = () => {
          e3 = we(i2), e3 ? r3.to(Object.assign(Object.assign({}, y$1), e3)) : ke();
        };
        l2.on("refresh", (() => {
          t3();
    ...
    d2 && R(d2), !c2 && a2 && d2 && (u2 = true, O(d2, a2, (() => {
      ke();
    }))), c2 || u2 ? setTimeout((() => {
      ke();
    }), 350) : ke();
  ...
  const Oe = { close: Me, destroy: ke, getCarousel: function() {
    ...
    const u2 = z.get(K);
    if (u2 && u2.destroy(), z.set(K, Oe), te("init"), (function() {
      ...
      const u3 = J("theme"), d2 = "auto" === u3 ? window.matchMedia("(prefers-color-scheme:light)").matches : "light" === u3;
      ...
      if (J("sync") && (null === (a2 = J("sync")) || void 0 === a2 || a2.goTo((null == B2 ? void 0 : B2.getPageIndex()) || 0, { transition: false, tween: false })), J("closeExisting")) for (const [e2, t3] of z.entries()) e2 !== K && t3.close();
...
const N = { Plugins: { Hash: d }, version: "6.1.4", openers: /* @__PURE__ */ new Map(), bind: function(e2, n2, o2, i2) {
  if (!e$2()) return;
...
//# sourceMappingURL=vendor.Dc9u7dAb.js.map
