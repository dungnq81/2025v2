...
const e$a = function(e2) {
  ...
  return n2 && !o2 && !i2;
}, n$8 = function(t2, o2 = void 0) {
  return !t2 || t2 === document.body || o2 && t2 === o2 ? null : e$a(t2) ? t2 : n$8(t2.parentElement, o2);
};
/*! License details at fancyapps.com/license */
...
function n$7(t2, r2) {
  ...
  return o2.length === c2.length && o2.every(((o3) => {
    ...
    return "function" == typeof c3 ? `${c3}` == `${i2}` : e$8(c3) && e$8(i2) ? n$7(c3, i2) : c3 === i2;
  }));
}
/*! License details at fancyapps.com/license */
const e$7 = function(n2) {
  for (const t2 of s$a) t2.getState() === i$7.Running && t2.tick(a$6 ? n2 - a$6 : 0);
  a$6 = n2, u$3 = window.requestAnimationFrame(e$7);
};
var i$7, o$6, r$5;
!(function(n2) {
...
let u$3 = null, a$6 = 0;
function c$2() {
  let a2 = i$7.Initializing, f2 = o$6.Ease, l2 = 0, g = 0, p2 = c$2.Easings.Linear, m2 = 500, d2 = 0, b2 = 0, S = 0, h2 = 0, y2 = 1 / 0, E2 = 0.01, R2 = 0.01, M2 = false, j2 = {}, w2 = null, v2 = {}, O2 = {}, C = {}, L = 0, I2 = 0, D2 = r$5.Loop, z2 = c$2.Easings.Linear;
  ...
  const F = { getState: function() {
    ...
    return n$7(v2, O2) || (a2 = i$7.Initializing, j2 = Object.assign({}, v2), s$a.add(this), u$3 || (u$3 = window.requestAnimationFrame(e$7)), q2(n2)), F;
  }, pause: function() {
    ...
    return V("step", v2, j2, O2, s2), u2 && a2 === i$7.Running && n$7(O2, c2) && (a2 = i$7.Completed, A()), F;
    ...
    a2 = i$7.Destroyed, w2 && (clearTimeout(w2), w2 = null), j2 = v2 = O2 = {}, s$a.delete(this);
  } };
  return F;
}
c$2.destroy = () => {
  for (const n2 of s$a) n2.destroy();
...
const f = (e2, t2) => {
  ...
  function C(e3) {
    ...
    e3 instanceof MouseEvent && (window.addEventListener("mousemove", I2), window.addEventListener("mouseup", B2)), window.addEventListener("blur", F), f2 = e3, m2 = o$5(e3), g = [...m2], E2 = [], x2 = m2.length, h2 = i$6(m2), 1 === x2 && (w2 = false, y2 = false, T = false), x2 && q2(i$6(m2));
  ...
  function I2(e3) {
    ...
    if (q2(s2), x2 = m2.length, h2 = s2, E2.length === m2.length ? (L = s2.x - o2.x, P = s2.y - o2.y) : (L = 0, P = 0), g.length) {
      const e4 = i$6(g);
    ...
    w2 || (w2 = Math.abs(D2) > p2.panThreshold || Math.abs(X) > p2.panThreshold, w2 && (d$1 = false, clearTimeout(A), A = 0, k2 = Math.abs(180 * Math.atan2(X, D2) / Math.PI), v2 = k2 > 45 && k2 < 135 ? "y" : "x", g = [...m2], E2 = [...m2], D2 = 0, X = 0, L = 0, P = 0, null === (t3 = window.getSelection()) || void 0 === t3 || t3.removeAllRanges(), S("panstart"))), w2 && (L || P) && S("pan"), S("move");
  }
  function B2(e3) {
    if (f2 = e3, !g.length) return;
    const t3 = o$5(e3), n2 = s$9(e3);
    if (x2 = t3.length, h2 = i$6(n2), n2.length && q2(i$6(n2)), E2 = [...m2], m2 = [...t3], g = [...t3], x2 > 0) S("end"), w2 = false, y2 = false, R2 = [];
    else {
  ...
  function G() {
    l$5 = false, w2 = false, y2 = false, b2 = false, x2 = 0, R2 = [], m2 = [], E2 = [], g = [], L = 0, P = 0, D2 = 0, X = 0, Y = 0, j2 = 0, k2 = 0, v2 = void 0, window.removeEventListener("mousemove", I2), window.removeEventListener("mouseup", B2), window.removeEventListener("blur", F), d$1 || A || (A = setTimeout((() => {
      d$1 = true, A = 0;
    }), 100));
  }
  function H2(e3) {
    const t3 = e3.target;
    l$5 = false, t3 && !e3.defaultPrevented && (d$1 || (r$4(e3), e3.stopPropagation()));
  }
  const J = { init: function() {
    return e2 && (e2.addEventListener("click", H2, a$5), e2.addEventListener("mousedown", C, a$5), e2.addEventListener("touchstart", C, a$5), e2.addEventListener("touchmove", I2, a$5), e2.addEventListener("touchend", B2), e2.addEventListener("touchcancel", B2)), J;
  }, on: function(e3, t3) {
    ...
    clearTimeout(z2), clearTimeout(A), A = 0, e2 && (e2.removeEventListener("click", H2, a$5), e2.removeEventListener("mousedown", C, a$5), e2.removeEventListener("touchstart", C, a$5), e2.removeEventListener("touchmove", I2, a$5), e2.removeEventListener("touchend", B2), e2.removeEventListener("touchcancel", B2)), e2 = null, G();
  } };
  return J;
};
f.isClickAllowed = () => d$1;
/*! License details at fancyapps.com/license */
...
const E$1 = (c2, b2 = {}, E2 = {}) => {
  ...
  function N() {
    var e2;
    c2 && (s$7(c2, "is-loading"), null === (e2 = c2.querySelector(".f-spinner")) || void 0 === e2 || e2.remove());
  }
  function V() {
    if (!c2 || !O2) return;
    if (N(), p(O2) && (!O2.complete || !O2.naturalWidth)) return P = 2, null == S || S.classList.add("has-error"), void H2("error");
    H2("loaded");
    const { width: e2, height: t2 } = J();
    p(O2) && (O2.setAttribute("width", e2 + ""), O2.setAttribute("height", t2 + "")), S && (s$7(S, "has-error"), p(O2) && (S.setAttribute("width", e2 + ""), S.setAttribute("height", t2 + ""), S.style.aspectRatio = `${e2 / t2 || ""}`)), F = c$2().on("start", ((e3, t3) => {
  ...
  function J() {
    ...
    if (O2 && "auto" === t2) {
      ...
      t2 = e2 ? parseFloat(e2 + "") : void 0 !== O2.dataset.width ? parseFloat(O2.dataset.width + "") : p(T) ? T.naturalWidth : p(O2) ? O2.naturalWidth : (null == S ? void 0 : S.getBoundingClientRect().width) || 0;
    } else t2 = t$7(t2) ? parseFloat(t2) : t2;
    if (O2 && "auto" === n2) {
      const e2 = O2.getAttribute("height");
      n2 = e2 ? parseFloat(e2 + "") : void 0 !== O2.dataset.height ? parseFloat(O2.dataset.height + "") : p(T) ? T.naturalHeight : p(O2) ? O2.naturalHeight : (null == S ? void 0 : S.getBoundingClientRect().height) || 0;
  ...
  function ce(e2) {
    ...
    s$6(S, "is-fullsize", a2), s$6(S, "is-expanded", i2), s$6(S, "is-dragging", o2), s$6(S, "can-drag", n2), s$6(S, "will-zoom-in", s2), s$6(S, "will-zoom-out", r2);
  ...
  function ue(e2, t2) {
    ...
    let p2 = t2.center;
    t2.srcEvent && (p2 = i$6(s$9(t2.srcEvent)));
  ...
  const je = { canDrag: be, canZoomIn: pe, canZoomOut: me, canZoomToFull: ve, destroy: function() {
    ...
    return P = 0, H2("init"), (function() {
      ...
      if (!c2) return;
      if (s$8(c2, e2.container), O2 = c2.querySelector("." + e2.content), !O2) return;
      O2.setAttribute("draggable", "false"), S = c2.querySelector("." + e2.wrapper), S || (S = document.createElement("div"), s$8(S, e2.wrapper), O2.insertAdjacentElement("beforebegin", S), S.insertAdjacentElement("afterbegin", O2));
      T = c2.querySelector("." + e2.viewport), T || (T = document.createElement("div"), s$8(T, e2.viewport), T.insertAdjacentElement("afterbegin", O2), S.insertAdjacentElement("beforeend", T));
      ...
      if (T && (T.style.visibility = "hidden", I2("protected"))) {
        ...
        s$8(e3, "f-panzoom__protected"), T.appendChild(e3);
      }
      H2("initLayout");
    })(), (function() {
      if (c2 && S && !Z) {
    ...
    return je;
  }, toggleFS: Me, updateControls: ce, version: "6.1.0", willZoomIn: ge, willZoomOut: he };
  return je;
};
...
/*! License details at fancyapps.com/license */
const o$4 = Object.assign(Object.assign({}, e$5), { ERROR: "Something went wrong. <br /> Please try again later.", NEXT: "Next page", PREV: "Previous page", GOTO: "Go to page #%d", DOWNLOAD: "Download", TOGGLE_FULLSCREEN: "Toggle full-screen mode", TOGGLE_EXPAND: "Toggle full-size mode", TOGGLE_THUMBS: "Toggle thumbnails", TOGGLE_AUTOPLAY: "Toggle slideshow" });
/*! License details at fancyapps.com/license */
const m = (e2) => {
  e2.cancelable && e2.preventDefault();
}, h = { adaptiveHeight: false, center: true, classes: { container: "f-carousel", isEnabled: "is-enabled", isLTR: "is-ltr", isRTL: "is-rtl", isHorizontal: "is-horizontal", isVertical: "is-vertical", hasAdaptiveHeight: "has-adaptive-height", viewport: "f-carousel__viewport", slide: "f-carousel__slide", isSelected: "is-selected" }, dragFree: false, enabled: true, errorTpl: '<div class="f-html">{{ERROR}}</div>', fill: false, infinite: true, initialPage: 0, l10n: o$4, rtl: false, slides: [], slidesPerPage: "auto", spinnerTpl: '<div class="f-spinner"></div>', transition: "fade", tween: { clamp: true, mass: 1, tension: 160, friction: 25, restDelta: 1, restSpeed: 1, velocity: 0 }, vertical: false };
let b, E = 0;
const y = (g, x2 = {}, M2 = {}) => {
  E++;
  let w2, S, j2, L, P, A = 0, O2 = Object.assign({}, h), T = Object.assign({}, h), R2 = {}, V = null, C = null, H2 = false, D2 = false, $2 = false, q2 = false, F = "height", I2 = 0, z2 = true, k2 = 0, N = 0, B2 = 0, _2 = 0, G = "*", X = [], Y = [];
  const W = /* @__PURE__ */ new Set();
  let J = [], K = [], Q = 0, U = 0, Z = 0;
  function ee(e2, ...t2) {
    let n2 = T[e2];
    return n2 && n2 instanceof Function ? n2($e, ...t2) : n2;
  }
  function te(e2, t2 = []) {
    const n2 = ee("l10n") || {};
    e2 = String(e2).replace(/\{\{(\w+)\}\}/g, ((e3, t3) => n2[t3] || e3));
  ...
  function ie(e2, ...t2) {
    ...
    for (const e3 of n2) e3 && e3 instanceof Function && e3($e, ...t2);
    "*" !== e2 && ie("*", e2, ...t2);
  }
  function oe() {
    var t2, n2;
    ...
    if (void 0 === P || r2 !== P) {
      ...
      Ce(), T = i2, false !== T.enabled && (A = 0, ie("init"), (function() {
        ...
        s$8(V, t3.container);
        const n3 = ee("style");
        if (n3 && t$5(n3)) for (const [e2, t4] of Object.entries(n3)) V.style.setProperty(e2, t4);
        C = V.querySelector(`.${t3.viewport}`), C || (C = document.createElement("div"), s$8(C, t3.viewport), C.append(...e$4(V, `.${t3.slide}`)), V.insertAdjacentElement("afterbegin", C)), V.carousel = $e, ie("initLayout");
      })(), (function() {
        if (!C) return;
        const e2 = ee("classes") || {};
        ...
        for (const e3 of X) {
          const t3 = e3.el;
          (null == t3 ? void 0 : t3.parentElement) === C && (s$8(t3, T.classes.slide), s$8(t3, e3.class), Oe(e3), ie("attachSlideEl", e3));
        }
        ie("initSlides");
      })(), Me(), A = 1, s$8(V, (ee("classes") || {}).isEnabled || ""), Ve(), ce(), S = c$2().on("start", (() => {
        w2 && w2.isPointerDown() || (ae(), Ve());
      })).on("step", ((e2) => {
        const t3 = I2;
        I2 = e2.pos, I2 !== t3 && (z2 = false, Ve());
      })).on("end", ((e2) => {
        (null == w2 ? void 0 : w2.isPointerDown()) || (I2 = e2.pos, S && !D2 && (I2 < B2 || I2 > _2) ? S.spring({ clamp: true, mass: 1, tension: 200, friction: 25, velocity: 0, restDelta: 1, restSpeed: 1 }).from({ pos: I2 }).to({ pos: t$6(B2, I2, _2) }).start() : z2 || (z2 = true, ie("settle")));
      })), re(), (function() {
        if (V && C && (V.addEventListener("click", Le, { passive: false }), document.addEventListener("mousemove", se), !j2)) {
          let e2 = true, t3 = null;
          j2 = new ResizeObserver((() => {
            e2 ? e2 = false : t3 || (t3 = requestAnimationFrame((() => {
              !(function() {
                if (1 !== A || !C) return;
                const e3 = K.length;
                Me(), re();
                const t4 = C.getBoundingClientRect(), n3 = t4.height, i3 = t4.width;
                e3 > 1 && (q2 && Math.abs(n3 - Q) < 0.5 || !q2 && Math.abs(i3 - U) < 0.5) || (Q = n3, U = i3, q2 && !n3 || !q2 && !i3 || V && C && (e3 === K.length && (null == w2 ? void 0 : w2.isPointerDown()) || (ee("dragFree") && (D2 || I2 > B2 && I2 < _2) ? (ae(), Ve()) : Te(k2, { transition: false }))));
              })(), t3 = null;
            })));
          })), j2.observe(C);
        }
  ...
  function re() {
    ...
    false !== e2 ? w2 || (w2 = f(C, e2).on("start", ((e3) => {
      ...
      q2 && e$6(o2) && !n$8(o2.target) && m(o2), S.pause(), S.getCurrentVelocities().pos = 0;
      const s2 = null === (t2 = K[k2]) || void 0 === t2 ? void 0 : t2.slides[0];
      if (s2 && W.has(s2.index) && s2.el && (I2 = s2.offset || 0, I2 += ((function(e4) {
        const t3 = window.getComputedStyle(e4), n3 = new DOMMatrixReadOnly(t3.transform);
        return { width: n3.m41 || 0, height: n3.m42 || 0 };
      })(s2.el)[F] || 0) * ($2 && !q2 ? 1 : -1)), Se(), !D2) {
        (I2 < B2 || I2 > _2) && S.spring({ clamp: true, mass: 1, tension: 500, friction: 25, velocity: (null === (n2 = S.getCurrentVelocities()) || void 0 === n2 ? void 0 : n2.pos) || 0, restDelta: 1, restSpeed: 1 }).from({ pos: I2 }).to({ pos: t$6(B2, I2, _2) }).start();
      }
    })).on("move", ((e3) => {
      var t2, n2;
      const { srcEvent: o2, axis: s2 } = e3, r2 = o2.target;
      if (s2 || (m(o2), o2.stopPropagation(), o2.stopImmediatePropagation()), ("y" === s2 && q2 || "x" === s2 && !q2) && (m(o2), o2.stopPropagation()), !s2) return;
      const { deltaX: l2, deltaY: a2 } = e3;
      if (!S) return;
      if (e$6(o2) && (null === (t2 = o2.touches) || void 0 === t2 ? void 0 : t2.length) > 1) return;
      if ("y" === s2 && !q2 || "x" === s2 && q2) return;
      if (r2 && n$8(r2) && ("x" !== s2 || q2)) return;
      const c2 = $2 && !q2 ? 1 : -1;
      let d2 = q2 ? a2 : l2, u2 = (null == S ? void 0 : S.isRunning()) ? S.getEndValues().pos : I2, f2 = 1;
      D2 || (u2 <= B2 && d2 * c2 < 0 ? (f2 = Math.max(0.01, 1 - (Math.abs(1 / ve() * Math.abs(u2 - B2)) || 0)), f2 *= 0.2) : u2 >= _2 && d2 * c2 > 0 && (f2 = Math.max(0.01, 1 - (Math.abs(1 / ve() * Math.abs(u2 - _2)) || 0)), f2 *= 0.2)), u2 += d2 * f2 * c2, S.spring({ clamp: true, mass: 1, tension: 700, friction: 25, velocity: (null === (n2 = S.getCurrentVelocities()) || void 0 === n2 ? void 0 : n2.pos) || 0, restDelta: 1, restSpeed: 1 }).from({ pos: I2 }).to({ pos: u2 }).start();
    })).on("panstart", ((e3) => {
      (null == e3 ? void 0 : e3.axis) === (q2 ? "y" : "x") && s$8(C, "is-dragging");
    })).on("panend", (() => {
      s$7(C, "is-dragging");
    })).on("end", ((e3) => {
      var t2, n2;
      ...
      const d2 = o2.target, u2 = d2 && n$8(d2) && !("x" === s2 && !q2);
      q2 && e$6(o2) && !e3.axis && Le(o2);
      const f2 = K.length, v2 = ee("dragFree");
      if (!f2) return;
      const g2 = ee("vertical") ? l2 : r2;
      let m2 = (null == S ? void 0 : S.isRunning()) ? S.getEndValues().pos : I2;
      const h2 = $2 && !q2 ? 1 : -1;
      if (u2 || (m2 += g2 * (v2 ? 5 : 1) * h2), !D2 && (g2 * h2 <= 0 && m2 < B2 || g2 * h2 >= 0 && m2 > _2)) {
        let e4 = 0;
        return Math.abs(g2) > 0 && (e4 = 2 * Math.abs(g2), e4 = Math.min(0.3 * ve(), e4)), m2 = t$6(B2 + -1 * e4, m2, _2 + e4), void S.spring({ clamp: true, mass: 1, tension: 380, friction: 25, velocity: -1 * g2, restDelta: 1, restSpeed: 1 }).from({ pos: I2 }).to({ pos: m2 }).start();
      }
      if (v2 || (null === (t2 = R2.Autoscroll) || void 0 === t2 ? void 0 : t2.isEnabled())) return void (Math.abs(g2) > 10 ? S.spring({ clamp: true, mass: 1, tension: 150, friction: 25, velocity: -1 * g2, restDelta: 1, restSpeed: 1 }).from({ pos: I2 }).to({ pos: m2 }).start() : S.isRunning() || z2 || (z2 = true, ie("settle")));
      if (!v2 && !(null === (n2 = R2.Autoscroll) || void 0 === n2 ? void 0 : n2.isEnabled()) && (!e3.offsetX && !e3.offsetY || "y" === s2 && !q2 || "x" === s2 && q2)) return void Te(k2, { transition: "tween" });
      let b2 = ue(m2);
      Math.abs(g2) > 10 && b2 === k2 && (b2 += g2 > 0 ? $2 && !q2 ? 1 : -1 : $2 && !q2 ? -1 : 1), Te(b2, { transition: "tween", tween: { velocity: -1 * g2 } });
  ...
  function ae() {
    if (!S) return;
    const e2 = ue((null == S ? void 0 : S.isRunning()) ? S.getEndValues().pos : I2);
    e2 !== k2 && (L = k2, k2 = e2, Oe(), ce(), de(), ie("change", k2, L));
  }
  function ce() {
    var e2;
    if (!V) return;
    s$6(C, "is-draggable", !!w2 && K.length > 0);
    for (const e3 of V.querySelectorAll("[data-carousel-index]")) e3.innerHTML = k2 + "";
    for (const e3 of V.querySelectorAll("[data-carousel-page]")) e3.innerHTML = k2 + 1 + "";
    for (const e3 of V.querySelectorAll("[data-carousel-pages]")) e3.innerHTML = K.length + "";
    for (const e3 of V.querySelectorAll("[data-carousel-go-prev]")) e3.toggleAttribute("aria-disabled", !He()), He() ? e3.removeAttribute("tabindex") : e3.setAttribute("tabindex", "-1");
    for (const e3 of V.querySelectorAll("[data-carousel-go-next]")) e3.toggleAttribute("aria-disabled", !De()), De() ? e3.removeAttribute("tabindex") : e3.setAttribute("tabindex", "-1");
    let t2 = false;
    const n2 = null === (e2 = K[k2]) || void 0 === e2 ? void 0 : e2.slides[0];
  ...
  function de(e2) {
    var t2;
    e2 || (e2 = null === (t2 = K[k2]) || void 0 === t2 ? void 0 : t2.slides[0]);
    const n2 = null == e2 ? void 0 : e2.el;
  ...
  function ue(e2) {
    ...
    const o2 = pe();
    let s2 = e2;
    D2 ? s2 -= Math.floor((e2 - (null === (t2 = K[0]) || void 0 === t2 ? void 0 : t2.pos)) / o2) * o2 || 0 : s2 = t$6(null === (n2 = K[0]) || void 0 === n2 ? void 0 : n2.pos, e2, null === (i2 = K[K.length - 1]) || void 0 === i2 ? void 0 : i2.pos);
    ...
    const c2 = r2.size > 0 ? [...r2.entries()].reduce(((e3, t3) => t3[1] < e3[1] ? t3 : e3)) : [k2, 0];
  ...
  function ve() {
    let e2 = 0;
    return C && (C.childElementCount || (C.style.display = "grid"), e2 = C.getBoundingClientRect()[F] || 0, C.style.display = ""), e2;
  }
  function pe(e2 = true) {
  ...
  function ge(e2) {
    ...
    if (!t2 || !C || !n2) return [];
    const i2 = [];
    e2 = void 0 === e2 ? I2 : e2, D2 && (e2 -= Math.floor(e2 / t2) * t2 || 0);
    let o2 = 0, s2 = 0;
    if (H2) {
      const e3 = C.getBoundingClientRect();
      o2 = Math.abs(e3[q2 ? "top" : "left"]), s2 = Math.abs(window[q2 ? "innerHeight" : "innerWidth"] - e3[q2 ? "bottom" : "right"]);
    }
    let r2 = 0;
    for (let l2 of Y) {
      const a2 = (t3 = 0) => {
  ...
  function he(e2) {
    return (t$7(e2) || e2 instanceof HTMLElement) && (e2 = { html: e2 }), Object.assign({ index: -1, el: void 0, class: "", isVirtual: true, dim: 0, pos: 0, offset: 0, html: "", src: "" }, e2);
  }
  function be(e2) {
    let t2 = e2.el;
    if (!e2 || !t2) return;
    const n2 = e2.html ? e2.html instanceof HTMLElement ? e2.html : e$9(e2.html) : void 0;
    n2 && (s$8(n2, "f-html"), e2.htmlEl = n2, s$8(t2, "has-html"), t2.append(n2), ie("contentReady", e2));
  }
  function Ee(e2) {
    if (!C || !e2) return;
    let t2 = e2.el;
    if (t2) {
      if (t2.setAttribute("index", e2.index + ""), t2.parentElement !== C) {
        let n2;
        s$8(t2, T.classes.slide), s$8(t2, e2.class), Oe(e2);
  ...
  function Me() {
    var e2, n2, i2, o2, s2;
    if (!V || !C) return;
    $2 = ee("rtl"), q2 = ee("vertical"), F = q2 ? "height" : "width";
    const r2 = ee("classes");
    if (s$6(V, r2.isLTR, !$2), s$6(V, r2.isRTL, $2), s$6(V, r2.isHorizontal, !q2), s$6(V, r2.isVertical, q2), s$6(V, r2.hasAdaptiveHeight, ee("adaptiveHeight")), !ve()) return;
    const l2 = window.getComputedStyle(C);
    H2 = "visible" === l2.getPropertyValue("overflow-" + (q2 ? "y" : "x")), Z = C && parseFloat(l2.getPropertyValue("--f-carousel-gap")) || 0;
    const d2 = (function() {
      let e3 = 0;
      if (C) {
        let t2 = document.createElement("div");
        t2.style.display = "block", s$8(t2, T.classes.slide), C.appendChild(t2), e3 = t2.getBoundingClientRect()[F], t2.remove(), t2 = void 0;
      }
      return e3;
    })();
    for (const n3 of Y) {
      ...
      if (!n3.isVirtual && i3 && n$9(i3)) {
        let t2 = false;
        i3.parentElement && i3.parentElement === C || (C.appendChild(i3), t2 = true), o3 = i3.getBoundingClientRect()[F], t2 && (null === (e2 = i3.parentElement) || void 0 === e2 || e2.removeChild(i3));
      } else o3 = d2;
      n3.dim = o3;
    }
    ...
    if ((function() {
      ...
      for (const e4 of K) {
        ...
        e4.offset = c2, e4.pos = c2, false !== r3 && (e4.pos -= 0.5 * (t2 - e4.dim)), l3 && !D2 && n3 > t2 && (e4.pos = t$6(0, e4.pos, n3 - t2)), c2 += e4.dim + Z;
      }
      const d3 = [];
      let u2;
      for (const e4 of K) {
      ...
      K = d3, ce();
    })(), B2 = (null === (i2 = K[0]) || void 0 === i2 ? void 0 : i2.pos) || 0, _2 = (null === (o2 = K[K.length - 1]) || void 0 === o2 ? void 0 : o2.pos) || 0, 0 === A) !(function() {
      var e3;
      L = void 0, k2 = ee("initialPage");
      const t2 = ee("initialSlide") || void 0;
      void 0 !== t2 && (k2 = $e.getPageIndex(t2) || 0), k2 = t$6(0, k2, K.length - 1), I2 = (null === (e3 = K[k2]) || void 0 === e3 ? void 0 : e3.pos) || 0, N = I2;
    })();
    else {
      const e3 = (null == S ? void 0 : S.isRunning()) ? S.getEndValues().pos : I2;
      (e3 < B2 || e3 > _2) && (N = (null === (s2 = K[k2 || 0]) || void 0 === s2 ? void 0 : s2.pos) || 0, I2 = t$6(B2, I2, _2));
    }
    ie("refresh");
  }
  function we(e2) {
    ...
    e2.removeEventListener("animationend", je), s$7(e2, o2.join(" ")), W.delete(n2);
  }
  function Se() {
    if (!C) return;
    const e2 = W.size > 0;
  ...
  function je(e2) {
    var t2;
    "f-" === (null === (t2 = e2.animationName) || void 0 === t2 ? void 0 : t2.substring(0, 2)) && (we(e2.target), W.size || (s$7(V, "in-transition"), !z2 && Math.abs($e.getPosition(true) - N) < 0.5 && (z2 = true, ie("settle"))), Ve());
  }
  function Le(e2) {
    var t2;
    if (e2.defaultPrevented) return;
    const n2 = e2.composedPath()[0];
    if (n2.closest("[data-carousel-go-prev]")) return m(e2), void $e.prev();
    if (n2.closest("[data-carousel-go-next]")) return m(e2), void $e.next();
    const i2 = n2.closest("[data-carousel-go-to]");
    if (i2) return m(e2), void $e.goTo(parseFloat(i2.dataset.carouselGoTo || "") || 0);
    if (n2.closest("[data-carousel-download]")) {
      m(e2);
      const n3 = null === (t2 = K[k2]) || void 0 === t2 ? void 0 : t2.slides[0];
  ...
  function Ae(e2) {
    var t2;
    const n2 = e2.el;
    n2 && (null === (t2 = n2.querySelector(".f-html.is-error")) || void 0 === t2 || t2.remove(), s$7(n2, "has-error"));
  }
  function Oe(e2) {
    var t2;
    e2 || (e2 = null === (t2 = K[k2]) || void 0 === t2 ? void 0 : t2.slides[0]);
    ...
    if (s2 && s2 instanceof HTMLElement) {
      if (e2.index !== k2) return;
      if (t$7(o2) && (s2.innerHTML = te(o2 + "")), o2 instanceof HTMLElement) {
    ...
    !r2 && o2 instanceof HTMLElement && o2.classList.contains("f-caption") && (r2 = o2), r2 || (r2 = document.createElement("div"), s$8(r2, "f-caption"), t$7(o2) ? r2.innerHTML = te(o2 + "") : o2 instanceof HTMLElement && (o2.parentElement && (o2 = o2.cloneNode(true)), r2.append(o2)));
    const l2 = `f-caption-${E}_${e2.index}`;
    r2.setAttribute("id", l2), r2.dataset.selectable = "true", s$8(i2, "has-caption"), i2.setAttribute("aria-labelledby", l2), e2.captionEl = r2, i2.insertAdjacentElement("beforeend", r2);
  }
  function Te(t2, i2 = {}) {
    var o2, r2;
    ...
    if ((function(e2, t3) {
      var i3, o3, s2, r3;
      if (!(V && S && t3 && t$7(t3) && "tween" !== t3)) return false;
      if ((null === (i3 = K[k2]) || void 0 === i3 ? void 0 : i3.slides.length) > 1) return false;
      const l3 = K.length;
      let u3 = e2 > k2 ? 1 : -1;
      e2 = D2 ? (e2 % l3 + l3) % l3 : t$6(0, e2, l3 - 1), $2 && (u3 *= -1);
      const f3 = null === (o3 = K[k2]) || void 0 === o3 ? void 0 : o3.slides[0], v3 = null == f3 ? void 0 : f3.index, p2 = null === (s2 = K[e2]) || void 0 === s2 ? void 0 : s2.slides[0], g2 = null == p2 ? void 0 : p2.index, m2 = null === (r3 = K[e2]) || void 0 === r3 ? void 0 : r3.pos;
      if (void 0 === g2 || void 0 === v3 || v3 === g2 || I2 === m2 || Math.abs(ve() - ((null == p2 ? void 0 : p2.dim) || 0)) > 1) return false;
      z2 = false, S.pause(), Se(), s$8(V, "in-transition"), I2 = N = m2;
      const h2 = Ee(f3), b2 = Ee(p2);
      return ae(), h2 && (W.add(v3), h2.style.transform = "", h2.addEventListener("animationend", je), s$7(h2, T.classes.isSelected), h2.inert = false, s$8(h2, `f-${t3}Out to-${u3 > 0 ? "next" : "prev"}`)), b2 && (W.add(g2), b2.style.transform = "", b2.addEventListener("animationend", je), s$8(b2, T.classes.isSelected), b2.inert = false, s$8(b2, `f-${t3}In from-${u3 > 0 ? "prev" : "next"}`)), Ve(), true;
    })(t2, l2)) return;
    t2 = D2 ? (t2 % f2 + f2) % f2 : t$6(0, t2, f2 - 1), N = (null === (o2 = K[t2 || 0]) || void 0 === o2 ? void 0 : o2.pos) || 0;
    const v2 = S.isRunning() ? S.getEndValues().pos : I2;
    if (Math.abs(N - v2) < 1) return I2 = N, k2 !== t2 && (Oe(), ce(), de(), L = k2, k2 = t2, ie("change", k2, L)), Ve(), void (z2 || (z2 = true, ie("settle")));
    if (S.pause(), Se(), D2) {
      const e2 = pe(), t3 = Math.floor((v2 - (null === (r2 = K[0]) || void 0 === r2 ? void 0 : r2.pos)) / e2) || 0, n2 = N + t3 * e2;
      N = [n2 + e2, n2, n2 - e2].reduce((function(e3, t4) {
        return Math.abs(t4 - v2) < Math.abs(e3 - v2) ? t4 : e3;
      }));
    }
    false !== l2 && t$5(u2) ? S.spring(r$3({}, T.tween, u2)).from({ pos: I2 }).to({ pos: N }).start() : (I2 = N, ae(), Ve(), z2 || (z2 = true, ie("settle")));
  }
  function Re(e2) {
    var t2;
    let n2 = I2;
    if (D2 && true !== e2) {
      const e3 = pe();
      n2 -= (Math.floor((I2 - (null === (t2 = K[0]) || void 0 === t2 ? void 0 : t2.pos) || 0) / e3) || 0) * e3;
    }
    return n2;
  }
  function Ve() {
    ...
    if (!V || !C) return;
    J = ge();
    const t2 = /* @__PURE__ */ new Set(), n2 = [], i2 = K[k2], s2 = T.setTransform || void 0;
    let l2;
    for (const o2 of Y) {
    ...
    C && l2 && (C.style.height = `${l2}px`), [...e$4(C, `.${T.classes.slide}`)].forEach(((e3) => {
      s$6(e3, T.classes.isSelected, t2.has(e3));
      ...
      i3 || (a2 = q2 ? 0 : $2 ? -1 * l3 : l3, c2 = q2 ? l3 : 0, d2 = t$3(a2, 0, n3.dim, 0, 100), f2 = t$3(c2, 0, n3.dim, 0, 100)), s2 instanceof Function && !i3 ? s2($e, n3, { x: a2, y: c2, xPercent: d2, yPercent: f2 }) : e3.style.transform = a2 || c2 ? `translate3d(${d2}%, ${f2}%,0)` : "";
    })), ie("render", n2);
  }
  function Ce() {
    var e2;
    null == V || V.removeEventListener("click", Le), Se(), document.removeEventListener("mousemove", se), null == j2 || j2.disconnect(), j2 = void 0;
    for (const n2 of X) n2.el && n$9(n2.el) && (n2.state = void 0, Pe(n2), Ae(n2), ye(n2), n2.isVirtual ? (null === (e2 = n2.el) || void 0 === e2 || e2.remove(), n2.el = void 0) : (n2.el.style.transform = "", null == C || C.appendChild(n2.el)));
    for (const e3 of Object.values(R2)) null == e3 || e3.destroy();
    R2 = {}, null == w2 || w2.destroy(), w2 = void 0, null == S || S.destroy(), S = void 0;
    for (const [e3, t2] of Object.entries(T.classes || {})) "container" !== e3 && s$7(V, t2);
    s$7(C, "is-draggable");
  }
  function He() {
    return D2 || k2 > 0;
  ...
  const $e = { add: function(e2, t2) {
    var n2, i2;
    let o2 = I2;
    const s2 = k2, r2 = pe(), l2 = (null == S ? void 0 : S.isRunning()) ? S.getEndValues().pos : I2, a2 = r2 && Math.floor((l2 - ((null === (n2 = K[0]) || void 0 === n2 ? void 0 : n2.pos) || 0)) / r2) || 0;
    return me(e2, t2), le(G), Me(), S && (s2 === k2 && (o2 -= a2 * r2), N = (null === (i2 = K[k2 || 0]) || void 0 === i2 ? void 0 : i2.pos) || 0, o2 === N ? I2 = N : S.spring({ clamp: true, mass: 1, tension: 300, friction: 25, restDelta: 1, restSpeed: 1 }).from({ pos: o2 }).to({ pos: N }).start()), Ve(), $e;
  }, canGoPrev: He, canGoNext: De, destroy: function() {
    return ie("destroy"), window.removeEventListener("resize", oe), Ce(), ne.clear(), V = null, K = [], X = [], T = Object.assign({}, h), R2 = {}, Y = [], P = void 0, G = "*", A = 2, $e;
  }, emit: ie, filter: function(e2 = "*") {
    return le(e2), Me(), Ve(), ie("filter", e2), $e;
    ...
    return k2;
  }, getPageIndexFromPosition: ue, getPageProgress: function(e2, t2) {
    var n2;
    void 0 === e2 && (e2 = k2);
    const i2 = K[e2];
    if (!i2) return e2 > k2 ? -1 : 1;
    const o2 = pe(), s2 = fe();
    let r2 = i2.pos, l2 = Re();
    if (D2 && true !== t2) {
      const e3 = Math.floor((l2 - (null === (n2 = K[0]) || void 0 === n2 ? void 0 : n2.pos)) / o2) || 0;
    ...
    void 0 === e2 && (e2 = k2);
    const n2 = K[e2];
    if (!n2) return e2 > k2 ? -1 : 1;
    const i2 = Re(), o2 = ve();
    let s2 = n2.pos;
    if (D2) {
      const e3 = pe(), n3 = s2 + (Math.floor((i2 - (null === (t2 = K[0]) || void 0 === t2 ? void 0 : t2.pos)) / e3) || 0) * e3;
      s2 = [n3 + e3, n3, n3 - e3].reduce((function(e4, t3) {
        return Math.abs(t3 - i2) < Math.abs(e4 - i2) ? t3 : e4;
      }));
    }
    ...
    return R2;
  }, getPosition: Re, getSlides: function() {
    return X;
  }, getState: function() {
    return A;
    ...
    return void 0 !== L;
  }, hideError: Ae, hideLoading: Pe, init: function() {
    if (!g || !n$9(g)) throw new Error("No Element found");
    return 0 !== A && (Ce(), A = 0), V = g, O2 = x2, window.removeEventListener("resize", oe), O2.breakpoints && window.addEventListener("resize", oe), oe(), $e;
  }, isInfinite: function() {
    return D2;
    ...
    return Te(k2 - 1, e2), $e;
  }, reInit: function(e2 = {}, t2 = {}) {
    return Ce(), A = 0, P = void 0, G = "*", x2 = e2, O2 = e2, M2 = t2, oe(), $e;
  }, remove: function(e2) {
    void 0 === e2 && (e2 = X.length - 1);
    const t2 = X[e2];
    return t2 && (ie("removeSlide", t2), t2.el && (we(t2.el), t2.el.remove(), t2.el = void 0), X.splice(e2, 1), le(G), Me(), k2 = t$6(0, k2, K.length - 1), Ve()), $e;
    ...
    if (n2) {
      ...
      s$8(i2, "f-html"), s$8(i2, "is-error"), i2.innerHTML = te(t2 || "<p>{{ERROR}}</p>"), e2.htmlEl = i2, s$8(n2, "has-html"), s$8(n2, "has-error"), n2.insertAdjacentElement("afterbegin", i2), ie("contentReady", e2);
    }
    return $e;
    ...
    return o2 && (s$8(o2, "f-spinner"), t2.insertAdjacentElement("beforeend", o2)), $e;
  }, version: "6.1.0" };
  return $e;
};
y.l10n = { en_EN: o$4 }, y.getDefaults = () => h;
/*! License details at fancyapps.com/license */
...
/*! License details at fancyapps.com/license */
const e$2 = { syncOnChange: false, syncOnClick: true, syncOnHover: false }, i$5 = () => {
  let i2, t2;
  function o2() {
    const t3 = null == i2 ? void 0 : i2.getOptions().Sync;
    return t$5(t3) ? Object.assign(Object.assign({}, e$2), t3) : e$2;
  }
  function s2(n2) {
    var e2, s3, l3;
...
/*! License details at fancyapps.com/license */
const s$4 = { showLoading: true, preload: 1 }, n$4 = "is-lazyloading", o$3 = "is-lazyloaded", l$4 = "has-lazyerror", i$4 = () => {
  let i2;
  function d2() {
    const e2 = null == i2 ? void 0 : i2.getOptions().Lazyload;
    return t$5(e2) ? Object.assign(Object.assign({}, s$4), e2) : s$4;
  }
  function r2(t2) {
    var s2;
    const r3 = t2.el;
      ...
      if (g) {
        if (y2 && g) {
          ...
          d2().showLoading && (null == i2 || i2.showLoading(t2)), r4.addEventListener("load", (() => {
            null == i2 || i2.hideLoading(t2), s$7(r4, l$4), r4 instanceof HTMLImageElement ? r4.decode().then((() => {
              s$7(r4, n$4), s$8(r4, o$3);
            })) : (s$7(r4, n$4), s$8(r4, o$3)), m3 || null == i2 || i2.emit("lazyLoad:loaded", t2, r4, g);
          })), r4.addEventListener("error", (() => {
            null == i2 || i2.hideLoading(t2), s$7(r4, n$4), s$8(r4, l$4), m3 || null == i2 || i2.emit("lazyLoad:error", t2, r4, g);
...
/*! License details at fancyapps.com/license */
const r$2 = 'tabindex="-1" width="24" height="24" viewBox="0 0 24 24"', i$3 = { prevTpl: `<svg ${r$2}><path d="M15 3l-9 9 9 9"></path></svg>`, nextTpl: `<svg ${r$2}><path d="M9 3l9 9-9 9"></path></svg>` }, s$3 = () => {
  let r2, s2, l2;
  function a2() {
    const t2 = null == r2 ? void 0 : r2.getOptions().Arrows;
    return t$5(t2) ? Object.assign(Object.assign({}, i$3), t2) : i$3;
  }
  function u2(e2) {
    if (!r2) return;
    const o2 = `<button data-carousel-go-${e2} tabindex="0" class="f-button is-arrow is-${e2}" title="{{${e2.toUpperCase()}}}">` + a2()[`${e2}Tpl`] + "</button", i2 = e$9(r2.localize(o2)) || void 0;
    return i2 && s$8(i2, a2()[`${e2}Class`]), i2;
  }
  function g() {
    var t2;
    null == s2 || s2.remove(), s2 = void 0, null == l2 || l2.remove(), l2 = void 0, null === (t2 = null == r2 ? void 0 : r2.getContainer()) || void 0 === t2 || t2.classList.remove("has-arrows");
  }
  function c2() {
    r2 && false !== r2.getOptions().Arrows && r2.getPages().length > 1 ? (!(function() {
      if (!r2) return;
      const t2 = r2.getViewport();
      t2 && (s2 || (s2 = u2("prev"), s2 && t2.insertAdjacentElement("beforebegin", s2)), l2 || (l2 = u2("next"), l2 && t2.insertAdjacentElement("afterend", l2)), s$6(r2.getContainer(), "has-arrows", !(!s2 && !l2)));
    })(), r2 && (null == s2 || s2.toggleAttribute("aria-disabled", !r2.canGoPrev()), null == l2 || l2.toggleAttribute("aria-disabled", !r2.canGoNext()))) : g();
  }
  return { init: function(t2) {
    r2 = t2.on(["change", "refresh"], c2);
  }, destroy: function() {
    g(), null == r2 || r2.off(["change", "refresh"], c2), r2 = void 0;
  } };
};
/*! License details at fancyapps.com/license */
...
const s$2 = Object.assign({ counter: { tpl: '<div class="f-counter"><span data-carousel-page></span>/<span data-carousel-pages></span></div>' }, download: { tpl: '<button data-carousel-download class="f-button" title="{{DOWNLOAD}}"><svg><path d="M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2M7 11l5 5 5-5M12 4v12"/></svg></button>' }, autoplay: { tpl: '<button data-autoplay-action="toggle" class="f-button" title="{{TOGGLE_AUTOPLAY}}"><svg><g><path d="M5 3.5 19 12 5 20.5Z"/></g><g><path d="M8 4v15M17 4v15"/></g></svg></button>' }, thumbs: { tpl: '<button data-thumbs-action="toggle" class="f-button" title="{{TOGGLE_THUMBS}}"><svg><rect width="18" height="14" x="3" y="3" rx="2"/><path d="M4 21h1M9 21h1M14 21h1M19 21h1"/></svg></button>' } }, v), a$3 = { absolute: false, display: { left: [], middle: ["zoomIn", "zoomOut", "toggle1to1", "rotateCCW", "rotateCW", "flipX", "flipY", "reset"], right: [] }, enabled: "auto", items: {} }, r$1 = () => {
  ...
  function c2() {
    ...
    const y2 = u2("display"), j2 = r$3({}, s$2, u2("items"));
...
const e$1 = { autoStart: true, pauseOnHover: true, showProgressbar: true, timeout: 2e3 }, n$3 = () => {
  ...
  function r2(o3) {
    ...
    let a3 = (t$5(i3) ? Object.assign(Object.assign({}, e$1), i3) : e$1)[o3];
  ...
  function c2() {
    if (!n2 || !i2 || l2 || a2 || o2 || !n2.isSettled() || (function() {
      var t3;
    ...
    !(function() {
      var t3, e2, o3, i3;
      if (!n2) return;
      if (g(), !r2("showProgressbar")) return;
  ...
  function d2() {
    ...
    if (i2) return;
    i2 = true, n2.emit("autoplay:start", r2("timeout")), null === (t2 = n2.getContainer()) || void 0 === t2 || t2.classList.add("has-autoplay"), null === (e2 = n2.getTween()) || void 0 === e2 || e2.on("start", y2);
    const o3 = null == n2 ? void 0 : n2.getContainer();
    o3 && r2("pauseOnHover") && matchMedia("(hover: hover)").matches && (o3.addEventListener("mouseenter", b2, false), o3.addEventListener("mouseleave", E2, false)), n2.on("change", h2), n2.on("settle", P), n2.on("contentReady", m2), n2.on("panzoom:touchStart", f2), n2.on("panzoom:wheel", f2), n2.isSettled() && c2();
  }
  function f2() {
    var t2, e2;
    if (u2(), g(), i2 && n2) {
    ...
    n2 && (n2.off("change", h2), n2.off("settle", P), n2.off("contentReady", m2), n2.off("panzoom:touchStart", f2), n2.off("panzoom:wheel", f2)), i2 = false, a2 = false;
  }
  function g() {
    s2 && (s2.remove(), s2 = null);
  }
  function v2() {
    n2 && n2.getPages().length > 1 && r2("autoStart") && d2();
  }
  function m2() {
    c2();
  }
  ...
  function h2() {
    !n2 || !(null == n2 ? void 0 : n2.isInfinite()) && n2.getPageIndex() === n2.getPages().length - 1 ? f2() : (g(), u2());
  }
  function P() {
    c2();
  }
  ...
  function E2() {
    l2 = false, i2 && !a2 && (null == n2 ? void 0 : n2.isSettled()) && c2();
  }
  const w2 = { init: function(t2) {
    n2 = t2, n2.on("ready", v2), n2.on("click", p2);
  }, destroy: function() {
    f2(), null == n2 || n2.off("ready", v2), null == n2 || n2.off("click", p2), n2 = void 0;
...
/*! License details at fancyapps.com/license */
const s$1 = { Carousel: { Lazyload: { showLoading: false } }, minCount: 2, showOnStart: true, thumbTpl: '<button aria-label="Slide to #{{page}}"><img draggable="false" alt="{{alt}}" data-lazy-src="{{src}}" /></button>', type: "modern" };
let u$1;
const a$2 = () => {
  let a2, c2, d2, f2, g = 0, m2 = 0, h2 = true;
  function v2(e2) {
    const n2 = null == a2 ? void 0 : a2.getOptions().Thumbs;
    let o2 = (t$5(n2) ? Object.assign(Object.assign({}, s$1), n2) : s$1)[e2];
  ...
  function p2() {
    ...
    return t2 >= v2("minCount");
  }
  function b2() {
    return "modern" === v2("type");
  }
  function y2() {
    return "scrollable" === v2("type");
  }
  function x2() {
    const t2 = [], e2 = (null == a2 ? void 0 : a2.getSlides()) || [];
    for (const n2 of e2) t2.push({ index: n2.index, html: S(n2) });
    return t2;
  }
  function S(t2) {
  ...
  function C(t2 = false) {
    ...
    if (!a2 || !n2 || d2) return;
    if (!p2()) return;
    const o2 = (null === (e2 = v2("Carousel")) || void 0 === e2 ? void 0 : e2.classes) || {};
    if (o2.container = o2.container || "f-thumbs", !d2) {
      const t3 = n2.nextElementSibling;
      (null == t3 ? void 0 : t3.classList.contains(o2.container)) && (d2 = t3);
    }
    if (!d2) {
      d2 = document.createElement("div");
      const t3 = v2("parentEl");
      t3 ? t3.insertAdjacentElement("beforeend", d2) : n2.insertAdjacentElement("afterend", d2);
    }
    s$8(d2, o2.container), s$8(d2, "f-thumbs"), s$8(d2, `is-${v2("type")}`), t2 && s$8(d2, "is-hidden");
  }
  function L() {
    if (!d2 || !y2()) return;
    f2 = document.createElement("div"), s$8(f2, "f-thumbs__viewport");
    let t2 = "";
    for (const e3 of x2()) {
      const n2 = e3.html || "";
      "string" == typeof n2 && (t2 += `<div index="${e3.index}" class="f-thumbs__slide">${n2}</div>`);
    }
    f2.innerHTML = t2, d2.append(f2), d2.addEventListener("click", ((t3) => {
      t3.preventDefault();
      const e3 = t3.target.closest("[index]"), n2 = parseInt((null == e3 ? void 0 : e3.getAttribute("index")) || "-1");
      a2 && n2 > -1 && a2.goTo(n2);
    }));
    const e2 = new IntersectionObserver(((t3) => {
      t3.forEach(((t4) => {
        t4.isIntersecting && t4.target instanceof HTMLImageElement && (t4.target.src = t4.target.getAttribute("data-lazy-src") + "", t4.target.removeAttribute("data-lazy-src"), e2.unobserve(t4.target));
      }));
    }), { root: f2, rootMargin: "100px" });
    d2.querySelectorAll("[data-lazy-src]").forEach(((t3) => {
      e2.observe(t3);
    })), null == a2 || a2.emit("thumbs:ready");
  }
  function T() {
    var t2;
    if (!u$1 || !a2 || !d2 || y2() || c2) return;
    const n2 = x2();
    if (!n2.length) return;
    const o2 = r$3({}, { Sync: { target: a2 }, Lazyload: { preload: 1 }, slides: n2, classes: { container: "f-thumbs", viewport: "f-thumbs__viewport", slide: "f-thumbs__slide" }, center: true, fill: !b2(), infinite: false, dragFree: true, rtl: a2.getOptions().rtl || false, slidesPerPage: (t3) => {
      let e2 = 0;
      return b2() && (!(function() {
        if (!b2()) return;
        if (!d2) return;
        const t4 = (t5) => d2 && parseFloat(getComputedStyle(d2).getPropertyValue("--f-thumb-" + t5)) || 0;
        g = t4("width"), m2 = t4("clip-width");
      })(), e2 = 4 * (g - m2)), t3 && t3.getTotalSlideDim() <= t3.getViewportDim() - e2 ? 1 / 0 : 1;
    } }, s$1.Carousel || {}, v2("Carousel") || {});
    c2 = u$1(d2, o2, { Sync: i$5, Lazyload: i$4 }), c2.on("ready", (() => {
      s$8(d2, "is-syncing"), null == a2 || a2.emit("thumbs:ready"), b2() && (null == a2 || a2.on("render", j2));
    })), c2.on("destroy", (() => {
      null == a2 || a2.emit("thumbs:destroy");
    })), c2.init(), null === (t2 = c2.getGestures()) || void 0 === t2 || t2.on("start", (() => {
      h2 = false;
    })), c2.on("click", ((t3, e2) => {
      const n3 = e2.target;
      if (n3) {
    ...
    })), s$8(a2.getContainer(), "has-thumbs"), _2();
  }
  function E2() {
    p2() && v2("showOnStart") && (C(), L());
  }
  function P() {
    var t2;
    p2() && (T(), null == a2 || a2.on("addSlide", M2), null == a2 || a2.on("click", O2), null == a2 || a2.on("refresh", $2), null === (t2 = null == a2 ? void 0 : a2.getGestures()) || void 0 === t2 || t2.on("start", w2), z2());
  }
  function w2() {
    var t2, e2;
    h2 = true;
  ...
  function j2() {
    var t2, e2;
    null == d2 || d2.classList.toggle("is-syncing", false === (null == a2 ? void 0 : a2.hasNavigated()) || (null === (t2 = null == a2 ? void 0 : a2.getTween()) || void 0 === t2 ? void 0 : t2.isRunning())), _2(), (null === (e2 = null == a2 ? void 0 : a2.getGestures()) || void 0 === e2 ? void 0 : e2.isPointerDown()) && (function() {
      if (!b2()) return;
      if (!a2 || !c2) return;
      if (!h2) return;
      const t3 = c2.getTween(), e3 = c2.getPages(), n2 = a2.getPageIndex() || 0, i2 = a2.getPageProgress() || 0;
      if (!(a2 && e3 && e3[n2] && t3)) return;
      const r2 = t3.isRunning() ? t3.getCurrentValues().pos : c2.getPosition();
      if (void 0 === r2) return;
      let l2 = e3[n2].pos + i2 * (g - m2);
      l2 = t$6(e3[0].pos, l2, e3[e3.length - 1].pos), t3.from({ pos: r2 }).to({ pos: l2 }).start();
    })();
  }
  function A() {
    h2 = true, z2();
  ...
  function M2(t2, e2) {
    null == c2 || c2.add({ html: S(e2) }, e2.index);
  }
  function O2(t2, e2) {
    const n2 = e2.target;
    n2 && !e2.defaultPrevented && "toggle" === n2.dataset.thumbsAction && (d2 || (C(true), L(), T()), d2 && d2.classList.toggle("is-hidden"));
  }
  function $2() {
    z2();
  }
  function z2() {
    if (!a2 || !f2 || !y2()) return;
    const t2 = a2.getPageIndex();
    f2.querySelectorAll(".is-selected").forEach(((t3) => {
      t3.classList.remove("is-selected");
    }));
    const e2 = f2.querySelector(`[index="${t2}"]`);
    if (e2) {
      e2.classList.add("is-selected");
      const t3 = f2.getBoundingClientRect(), n2 = e2.getBoundingClientRect(), o2 = e2.offsetTop - f2.offsetTop - 0.5 * t3.height + 0.5 * n2.height, i2 = e2.scrollLeft - f2.scrollLeft - 0.5 * t3.width + 0.5 * n2.width;
      f2.scrollTo({ top: o2, left: i2, behavior: "smooth" });
    }
  }
  function _2() {
    if (!b2()) return;
    if (!a2 || !c2) return;
    const t2 = (null == c2 ? void 0 : c2.getSlides()) || [];
    let e2 = -0.5 * g;
    for (const n2 of t2) {
      const t3 = n2.el;
      if (!t3) continue;
      let o2 = a2.getPageProgress(n2.index) || 0;
      o2 = Math.max(-1, Math.min(1, o2)), o2 > -1 && o2 < 1 && (e2 += 0.5 * g * (1 - Math.abs(o2))), o2 = Math.round(1e4 * o2) / 1e4, e2 = Math.round(1e4 * e2) / 1e4, t3.style.setProperty("--progress", `${Math.abs(o2)}`), t3.style.setProperty("--shift", `${(null == a2 ? void 0 : a2.isRTL()) ? -1 * e2 : e2}px`), o2 > -1 && o2 < 1 && (e2 += 0.5 * g * (1 - Math.abs(o2)));
    }
  }
  return { init: function(t2, e2) {
    u$1 = e2, a2 = t2, a2.on("ready", P), a2.on("initSlides", E2), a2.on("change", A);
  }, destroy: function() {
    var t2, e2;
    y2() && (null == a2 || a2.emit("thumbs:destroy")), null == a2 || a2.off("ready", P), null == a2 || a2.off("initSlides", E2), null == a2 || a2.off("change", A), null == a2 || a2.off("render", j2), null == a2 || a2.off("addSlide", M2), null == a2 || a2.off("click", O2), null == a2 || a2.off("refresh", $2), null === (t2 = null == a2 ? void 0 : a2.getGestures()) || void 0 === t2 || t2.off("start", w2), null === (e2 = null == a2 ? void 0 : a2.getContainer()) || void 0 === e2 || e2.classList.remove("has-thumbs"), a2 = void 0, null == c2 || c2.destroy(), c2 = void 0, null == d2 || d2.remove(), d2 = void 0;
...
const n$2 = (t2, e2 = {}) => {
  ...
  function u2(t2, n2) {
    "html5video" === n2.type && (function(t3) {
      ...
      if (!s3) return;
      const c3 = t3.poster || (t3.thumb && t$7(t3.thumb) ? t3.thumb : ""), d3 = e$9(s3.replace(/\{\{src\}\}/gi, i2 + "").replace(/\{\{format\}\}/gi, r3 || "").replace(/\{\{poster\}\}/gi, c3 + ""));
      if (!d3) return;
...
/*! License details at fancyapps.com/license */
let e, n = false, o$1 = false, r = false, i = false;
const l = () => {
  ...
  if (!e) return;
  if (s()) return;
  const { urlSlug: t2, urlIndex: n2 } = l();
  if (!t2) return;
  let o2 = document.querySelector(`[data-slug="${t2}"]`);
  if (o2 && o2.dispatchEvent(new CustomEvent("click", { bubbles: true, cancelable: true })), s()) return;
  const r2 = document.querySelectorAll(`[data-fancybox="${t2}"]`);
  if (!r2.length) return;
  const i2 = r2[n2 - 1];
  ...
  const { urlSlug: o2, urlIndex: s2 } = l();
  if (t2 && n2) {
    const e2 = n2.getSlides();
    for (const t3 of e2 || []) if (o2 === t3.slug || o2 === t3.fancybox && t3.index === s2 - 1) return void n2.goTo(t3.index);
    i = true, t2.close(), i = false;
  }
  a();
}, c = () => {
  e && setTimeout((() => {
    n = true, a(), n = false, window.addEventListener("hashchange", u, false);
  }), 300);
}, d = () => {
  let t2, e2 = "auto", s2 = "";
  function a2() {
    ...
    const a3 = t2.getCarousel();
    if (!a3) return;
    const { urlHash: c3, urlSlug: d2 } = l(), f2 = t2.getSlide();
    if (!f2) return;
    let h2 = f2.slug || f2.fancybox || "", g = parseInt(f2.index + "", 10) + 1;
    if (!h2) return;
    let w2 = f2.slug ? `#${f2.slug}` : `#${h2}-${g}`;
    if (((null === (i2 = null === (r2 = t2.getCarousel()) || void 0 === r2 ? void 0 : r2.getPages()) || void 0 === i2 ? void 0 : i2.length) || 0) < 2 && (w2 = `#${h2}`), c3 !== w2 && (s2 = c3), history.scrollRestoration && (e2 = history.scrollRestoration, history.scrollRestoration = "manual"), a3.on("change", u2), n) return;
    const p2 = h2 !== d2;
    try {
      window.history[p2 ? "pushState" : "replaceState"]({}, document.title, window.location.pathname + window.location.search + w2);
    } catch (t3) {
    }
    p2 && (o$1 = true);
  }
  function u2() {
    ...
    if (!e3) return;
    let n2 = e3.slug || e3.fancybox || "", o2 = e3.index + 1, i2 = e3.slug ? `#${e3.slug}` : `#${n2}-${o2}`;
    r = true;
    try {
      window.history.replaceState({}, document.title, window.location.pathname + window.location.search + i2);
    } catch (t3) {
    }
    r = false;
  }
  ...
  return { init: function(e3) {
    t2 = e3, t2.on("ready", a2), t2.on("close", c2);
  }, destroy: function() {
    null == t2 || t2.off("ready", a2), null == t2 || t2.off("close", c2);
    const n2 = null == t2 ? void 0 : t2.getCarousel();
    n2 && n2.off("change", u2), t2 = void 0, history.scrollRestoration && e2 && (history.scrollRestoration = e2);
  } };
};
d.startFromUrl = a, d.setup = function(n2) {
  e || (e = n2, e$3() && (/complete|interactive|loaded/.test(document.readyState) ? c() : document.addEventListener("DOMContentLoaded", c)));
};
/*! License details at fancyapps.com/license */
const o = Object.assign(Object.assign({}, o$4), { CLOSE: "Close", NEXT: "Next", PREV: "Previous", MODAL: "You can close this modal content with the ESC key", ELEMENT_NOT_FOUND: "HTML Element Not Found", IFRAME_ERROR: "Error Loading Page" });
/*! License details at fancyapps.com/license */
...
const D = "with-fancybox", B = () => {
  ...
  function ne(t2 = [], n2 = {}) {
    W !== _.Init && (Oe.destroy(), W = _.Init), $2 = r$3({}, I, n2), K = J("id") || "fancybox-" + ++z;
    const a2 = H.get(K);
    if (a2 && a2.destroy(), H.set(K, Oe), te("init"), (function() {
      for (const [e2, t3] of Object.entries(Object.assign(Object.assign({}, q.Plugins), $2.plugins || {}))) if (e2 && !U[e2] && t3 instanceof Function) {
        const n3 = t3();
        n3.init(Oe), U[e2] = n3;
      }
      te("initPlugins");
      ...
      T.setAttribute("theme", d2 ? "light" : "dark"), r2.setAttribute("id", `${K}`), r2.addEventListener("keydown", ((e2) => {
        ...
        Z && r3 - Z < 300 ? o2 && k(e2) : (Z = r3, te("wheel", e2, l3), e2.defaultPrevented || ("close" === n4 ? Ae(e2) : "slide" === n4 && B2 && !n$8(t4) && (k(e2), B2[l3 > 0 ? "prev" : "next"]())));
      }), { capture: true, passive: false }), r2.addEventListener("cancel", ((e2) => {
        Ae(e2);
      })), t3.append(r2), 1 === H.size && (J("hideScrollbar") && t$2(true), document.documentElement.classList.add(D));
      ...
      } }, Fullscreen: { el: T }, Toolbar: { absolute: true, items: { counter: { tpl: '<div class="f-counter"><span data-fancybox-page></span>/<span data-fancybox-pages></span></div>' } }, display: { left: ["counter"], right: ["toggleFull", "autoplay", "fullscreen", "thumbs", "close"] } }, Video: { autoplay: true }, Thumbs: { minCount: 2, Carousel: { classes: { container: "fancybox__thumbs" } } }, classes: { container: "fancybox__carousel", viewport: "fancybox__viewport", slide: "fancybox__slide" }, spinnerTpl: '<div class="f-spinner" data-fancybox-close></div>', dragFree: false, slidesPerPage: 1, plugins: { Sync: i$5, Arrows: s$3, Lazyload: i$4, Zoomable: s$5, Html: i$2, Video: l$2, Autoplay: n$3, Fullscreen: l$1, Thumbs: a$2, Toolbar: r$1 } }, J("Carousel") || {}, { slides: X, enabled: true, initialPage: J("startIndex") || 0, l10n: J("l10n") });
      ...
      J("fadeEffect") ? (setTimeout((() => {
        oe();
      }), 500), s$8(T, "is-revealing")) : oe(), T.classList.add("is-ready"), W = _.Ready, te("ready");
    }
  }
  function oe() {
    s$7(T, "is-revealing");
  ...
  function ie(e2, n2) {
    ...
    ye(n2), fe(), null === (o2 = n2.el) || void 0 === o2 || o2.addEventListener("click", le), "inline" !== n2.type && "clone" !== n2.type || (function(e3) {
      ...
      if (n3) {
        if (s$8(n3, "f-html"), "clone" === e3.type || n3.closest(".fancybox__carousel")) {
        ...
        e3.htmlEl = n3, s$8(e3.el, "has-html"), e3.el.prepend(n3), n3.classList.remove("hidden"), "none" === n3.style.display && (n3.style.display = ""), "none" === getComputedStyle(n3).getPropertyValue("display") && (n3.style.display = n3.dataset.display || "flex"), null == B2 || B2.emit("contentReady", e3);
  ...
  function ae() {
    ...
    !(function() {
      ...
      function r3() {
        ...
        if (i2 && s3) if (0 === o2) s3.execute(v$1.Reset);
          ...
          const e5 = t$3(Math.abs(n2), 0, 0.33 * i2, l2, 0.75 * l2, false);
      ...
      const c2 = (e4) => {
        ...
        return B2 && !(e$6(n3) && (null === (t4 = n3.touches) || void 0 === t4 ? void 0 : t4.length) > 1) && o3 && !n$8(o3);
      };
      F = c$2().on("step", ((t4) => {
        if (T && e3 && W === _.Ready) {
    ...
    })(), document.body.addEventListener("click", ve), document.body.addEventListener("keydown", pe, { passive: false, capture: true }), fe(), je();
    const t2 = J("sync");
    t2 && (null === (e2 = t2.getTween()) || void 0 === e2 || e2.start()), he(Ee());
  }
  function ce() {
  ...
  function de() {
    ...
    s$6(T, "has-thumbs", (null == t2 ? void 0 : t2.isEnabled()) || false), s$6(T, "has-vertical-thumbs", !!t2 && ("scrollable" === t2.getType() || true === (null === (e2 = t2.getCarousel()) || void 0 === e2 ? void 0 : e2.isVertical())));
  }
  function fe() {
    if (T) {
  ...
  function ye(e2) {
    ...
    if ("auto" === l2 && (l2 = true !== (null === (t2 = null == B2 ? void 0 : B2.getPlugins().Toolbar) || void 0 === t2 ? void 0 : t2.isEnabled())), l2) {
      const t3 = e$9(Q(M));
      t3 && (s$8(t3, "is-close-button"), e2.closeButtonEl = i2.insertAdjacentElement("afterbegin", t3), n2.classList.add("has-close-btn"));
    }
  }
  function he(e2) {
  ...
  function be() {
    var e2;
    return (null === (e2 = q.getInstance()) || void 0 === e2 ? void 0 : e2.getId()) === K;
  }
  function Ee() {
    var e2;
  ...
  function je() {
    ...
    if (V) return;
    const e2 = J("idle");
    e2 && (V = setTimeout(Pe, e2));
  }
  function Pe() {
    T && (Le(), s$8(T, "is-idle"), document.addEventListener("mousemove", ge), G = true);
  }
  function Se() {
    G && (Ce(), je());
  }
  ...
  function Ae(e2, t2) {
    ...
    if (W = _.Closing, null == F || F.pause(), null == N || N.destroy(), B2) {
  ...
  function Me(e2, t2) {
    ...
    te("close", e2), Y = false, document.body.removeEventListener("click", ve), document.body.removeEventListener("keydown", pe, { passive: false, capture: true }), Te(), J("fadeEffect") && (null == T || T.classList.remove("is-ready"), null == T || T.classList.add("is-hiding")), null == T || T.classList.add("is-closing");
    const i2 = Ee(), s2 = null == i2 ? void 0 : i2.el, l2 = null == i2 ? void 0 : i2.panzoomRef, r3 = null === (n2 = null == i2 ? void 0 : i2.panzoomRef) || void 0 === n2 ? void 0 : n2.getTween(), a2 = t2 || J("hideClass");
    let c2 = false, u2 = false;
    if (B2 && i2 && s2 && l2 && r3) {
      let e3;
      if (J("zoomEffect") && 1 === i2.state && (e3 = we(i2)), e3) {
        c2 = true;
        const t3 = () => {
          e3 = we(i2), e3 && r3.to(Object.assign(Object.assign({}, y$1), e3));
        };
        l2.on("refresh", (() => {
          t3();
        })), r3.easing(c$2.Easings.EaseOut).duration(350).from(Object.assign({}, l2.getTransform())).to(Object.assign(Object.assign({}, y$1), e3)).start(), (null == s2 ? void 0 : s2.getAnimations()) && (s2.style.animationPlayState = "paused", requestAnimationFrame((() => {
          t3();
        })));
      }
    }
    const d2 = (null == i2 ? void 0 : i2.htmlEl) || (null === (o2 = null == i2 ? void 0 : i2.panzoomRef) || void 0 === o2 ? void 0 : o2.getWrapper());
    d2 && O(d2), !c2 && a2 && d2 && (u2 = true, R(d2, a2, (() => {
      ke();
    }))), c2 || u2 ? setTimeout((() => {
      ke();
    }), 350) : ke();
  ...
  function ke() {
    ...
    if (U = {}, null == r2 || r2.remove(), r2 = void 0, T = void 0, B2 = void 0, H.delete(K), !H.size && (t$2(false), document.documentElement.classList.remove(D), J("placeFocusBack"))) try {
...
const q = { Plugins: { Hash: d }, version: "6.1.0", openers: /* @__PURE__ */ new Map(), bind: function(e2, n2, o2) {
  if (!e$3()) return;
  let i2 = document.body, s2 = "[data-fancybox]", l2 = {};
  if (t$7(e2) ? (i2 = document.body, s2 = e2, "object" == typeof n2 && (l2 = n2 || {})) : e2 instanceof Element && (i2 = e2, t$7(n2) && (s2 = n2), "object" == typeof o2 && (l2 = o2 || {})), !(i2 && i2 instanceof Element && s2)) return false;
  const a2 = q.openers.get(i2) || /* @__PURE__ */ new Map();
  if (a2.set(s2, l2), q.openers.set(i2, a2), 1 === a2.size) {
    i2.addEventListener("click", q.fromEvent);
    for (const e3 of Object.values(q.Plugins)) {
      const t2 = e3.setup;
      "function" == typeof t2 && t2(q);
    }
  }
  return true;
  ...
  if (e2) for (const e3 of H.values()) e3.close(...t2);
    ...
    const e3 = q.getInstance();
    e3 && e3.close(...t2);
  }
}, destroy: function() {
  let e2;
  for (; e2 = q.getInstance(); ) e2.destroy();
  for (const e3 of q.openers.keys()) e3.removeEventListener("click", q.fromEvent);
  q.openers.clear();
  ...
  let r2, a2, c2 = {};
  for (const [e3, t3] of q.openers) if (t3 && e3.contains(i2)) for (const [n3, o3] of t3) {
    let t4 = null;
    try {
      t4 = i2.closest(n3);
    } catch (e4) {
  ...
  if (!r2 || !a2) return;
  k(e2);
  const u2 = r$3({}, I, { triggerEvent: e2, triggerEl: i2, delegateEl: s2 }, c2), d2 = u2.groupAll, f2 = u2.groupAttr, m2 = f2 && i2 ? i2.getAttribute(`${f2}`) : "";
  let g = [];
  const p2 = null === (t2 = i2.closest(".f-carousel")) || void 0 === t2 ? void 0 : t2.carousel;
  if (p2) {
    const e3 = [];
    for (const t3 of null == p2 ? void 0 : p2.getSlides()) {
      const n3 = t3.el;
      n3 && (n3.matches(a2) ? e3.push(n3) : e3.push(...[].slice.call(n3.querySelectorAll(a2))));
    }
    e3.length && (g = [...e3], null === (n2 = p2.getPlugins().Autoplay) || void 0 === n2 || n2.pause(), null === (o2 = p2.getPlugins().Autoscroll) || void 0 === o2 || o2.pause(), u2.sync = p2);
  } else (!i2 || m2 || d2) && (g = [].slice.call(r2.querySelectorAll(a2)));
  if (i2 && !d2 && (g = f2 && m2 ? g.filter(((e3) => e3.getAttribute(`${f2}`) === m2)) : [i2]), !g.length) return;
  const v2 = q.getInstance();
  if (v2) {
    const e3 = v2.getOptions().triggerEl;
    if (e3 && g.indexOf(e3) > -1) return;
  }
  return Object.assign({}, u2.Carousel || {}).rtl && (g = g.reverse()), i2 && (u2.startIndex = g.indexOf(i2)), q.fromNodes(g, u2);
  ...
  if (t$7(e2) ? s2 = e2 : e2 instanceof Element && (i2 = e2, t$7(n2) && (s2 = n2), "object" == typeof o2 && (r2 = o2 || {})), !(i2 && i2 instanceof Element && s2)) return;
  const a2 = q.openers.get(i2);
  return a2 ? (r2 = r$3({}, a2.get(s2) || {}, r2), r2 ? q.fromNodes(Array.from(i2.querySelectorAll(s2)), r2) : void 0) : void 0;
}, getCarousel: function() {
  var e2;
  return (null === (e2 = q.getInstance()) || void 0 === e2 ? void 0 : e2.getCarousel()) || void 0;
  ...
  var e2;
  return (null === (e2 = q.getInstance()) || void 0 === e2 ? void 0 : e2.getSlide()) || void 0;
}, show: function(e2 = [], t2 = {}) {
  return B().init(e2, t2);
}, unbind: function(e2, n2) {
  let o2 = document.body, i2 = "";
  if (t$7(e2) ? i2 = e2 : e2 instanceof Element && (o2 = e2, t$7(n2) && (i2 = n2)), o2) {
    const e3 = q.openers.get(o2);
    e3 && i2 && e3.delete(i2), (null == e3 ? void 0 : e3.size) && i2 || q.openers.delete(o2), o2.removeEventListener("click", q.fromEvent);
  }
} };
export {
  Autoplay as A,
...
//# sourceMappingURL=vendor.8dO39Lh6.js.map
