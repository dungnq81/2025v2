...
const initSwiper = (el) => {
  ...
  const classes2 = generateClasses();
  el.classList.add(classes2.swiper);
  const swiperOptions = {
  ...
  if (options.autoplay) {
    swiperOptions.autoplay = {
      ...
      disableOnInteraction: options.disableOnInteraction !== void 0 ? !!options.disableOnInteraction : true,
  ...
  if (options.navigation) {
    ...
    if (btnPrev && btnNext) {
      btnPrev.classList.add(classes2.prev);
      btnNext.classList.add(classes2.next);
    } else {
      const btnPrev2 = document.createElement("div");
      const btnNext2 = document.createElement("div");
      btnPrev2.className = `swiper-button swiper-button-prev ${classes2.prev}`;
      btnNext2.className = `swiper-button swiper-button-next ${classes2.next}`;
      btnPrev2.innerHTML = `<svg class="!h-6 !w-6"><use href="#icon-arrow-left-outline"></use></svg>`;
      btnNext2.innerHTML = `<svg class="!h-6 !w-6"><use href="#icon-arrow-right-outline"></use></svg>`;
      controls.append(btnPrev2, btnNext2);
    }
    swiperOptions.navigation = {
      nextEl: "." + classes2.next,
      prevEl: "." + classes2.prev
    };
  }
  if (options.pagination) {
    let pagination = controls?.querySelector(".swiper-pagination");
    if (pagination) {
      pagination.classList.add(classes2.pagination);
    } else {
      const pagination2 = document.createElement("div");
      pagination2.className = `swiper-pagination ${classes2.pagination}`;
      controls.append(pagination2);
    }
    const paginationType = options.pagination;
    swiperOptions.pagination = {
      el: "." + classes2.pagination,
      clickable: true,
  ...
  if (options.scrollbar) {
    ...
    if (scrollbar) {
      scrollbar.classList.add(classes2.scrollbar);
    } else {
      const scrollbar2 = document.createElement("div");
      scrollbar2.className = `swiper-scrollbar ${classes2.scrollbar}`;
      controls.append(scrollbar2);
    }
    swiperOptions.scrollbar = {
      el: "." + classes2.scrollbar,
      hide: true,
      draggable: true
    };
  }
  if (options.autoplayProgress) {
    ...
    progress.className = `swiper-autoplay-progress ${classes2.progress}`;
  ...
  const swiperInstance = new Swiper(`.${classes2.swiper}`, swiperOptions);
