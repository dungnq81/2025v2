...
function History(_ref) {
  ...
  const getPathValues = (urlOverride) => {
    ...
    const pathArray = location2.pathname.slice(1).split("/").filter((part2) => part2 !== "");
...
function requireJquery() {
  ...
  (function(module) {
    (function(global, factory) {
      ...
      (function() {
        var i, Expr, outermostContext, sortInput, hasDuplicate, push2 = pushNative, document3, documentElement3, documentIsHTML, rbuggyQSA, matches, expando = jQuery.expando, dirruns = 0, done = 0, classCache = createCache(), tokenCache = createCache(), compilerCache = createCache(), nonnativeSelectorCache = createCache(), sortOrder = function(a, b) {
          if (a === b) {
            hasDuplicate = true;
          }
          return 0;
...
//# sourceMappingURL=vendor.7IaWbD2V.js.map
