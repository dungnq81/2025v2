...
let u$3 = null, a$6 = 0;
function c$3() {
  let a2 = i$7.Initializing, f2 = o$6.Ease, l2 = 0, g = 0, p2 = c$3.Easings.Linear, m2 = 500, d2 = 0, b2 = 0, S = 0, h2 = 0, y2 = 1 / 0, E2 = 0.01, R2 = 0.01, M2 = false, j2 = {}, w2 = null, v2 = {}, O2 = {}, C = {}, L = 0, I2 = 0, D2 = r$5.Loop, z2 = c$3.Easings.Linear;
  ...
  const F = { getState: function() {
    ...
    return n$7(v2, O2) || (a2 = i$7.Initializing, j2 = Object.assign({}, v2), s$9.add(this), u$3 || (u$3 = window.requestAnimationFrame(e$7)), q2(n2)), F;
  }, pause: function() {
...
const f = (e2, t2) => {
  ...
  function S(e3) {
    const t3 = c$2(m2), n2 = c$2(E2), o2 = t3 && n2 ? t3 / n2 : 0, s2 = Math.abs(Y) > Math.abs(j2) ? Y : j2, i2 = { srcEvent: f2, isPanRecognized: w2, isSwipeRecognized: y2, firstTouch: g, previousTouch: E2, currentTouch: m2, deltaX: L, deltaY: P, offsetX: D2, offsetY: X, velocityX: Y, velocityY: j2, velocity: s2, angle: k2, axis: v2, scale: o2, center: h2 };
...
const E$1 = (c2, b2 = {}, E2 = {}) => {
  ...
  const je = { canDrag: be, canZoomIn: pe, canZoomOut: me, canZoomToFull: ve, destroy: function() {
    ...
    return je;
  }, toggleFS: Me, updateControls: ce, version: "6.1.2", willZoomIn: ge, willZoomOut: he };
  return je;
};
...
const y = (g, x2 = {}, w2 = {}) => {
  E++;
  let M2, S, j2, A, L, P = 0, T = Object.assign({}, h), O2 = Object.assign({}, h), R2 = {}, V = null, C = null, H2 = false, D2 = false, $2 = false, q2 = false, I2 = "height", F = 0, z2 = true, k2 = 0, B2 = 0, N = 0, _2 = 0, G = "*", X = [], Y = [];
  ...
  function ot() {
    ...
    if (void 0 === L || r2 !== L) {
      ...
      Ct(), O2 = i2, false !== tt("enabled") && (P = 0, it("init"), (function() {
        ...
        s$7(V, e3.container);
        const n3 = tt("style");
        if (n3 && t$5(n3)) for (const [t2, e4] of Object.entries(n3)) V.style.setProperty(t2, e4);
        C = V.querySelector(`.${e3.viewport}`), C || (C = document.createElement("div"), s$7(C, e3.viewport), C.append(...e$4(V, `.${e3.slide}`)), V.insertAdjacentElement("afterbegin", C)), V.carousel = $t, it("initLayout");
      })(), (function() {
        if (!C) return;
        const t2 = tt("classes") || {};
        X = [], [...e$4(C, `.${t2.slide}`)].forEach(((t3) => {
          if (t3.parentElement) {
        ...
        it("initSlides");
      })(), wt(), P = 1, s$7(V, (tt("classes") || {}).isEnabled || ""), Vt(), ct(), S = c$3().on("start", (() => {
        M2 && M2.isPointerDown() || (at(), Vt());
      })).on("step", ((t2) => {
        const e3 = F;
        F = t2.pos, F !== e3 && (z2 = false, Vt());
      })).on("end", ((t2) => {
        (null == M2 ? void 0 : M2.isPointerDown()) || (F = t2.pos, S && !D2 && (F < N || F > _2) ? S.spring({ clamp: true, mass: 1, tension: 200, friction: 25, velocity: 0, restDelta: 1, restSpeed: 1 }).from({ pos: F }).to({ pos: t$6(N, F, _2) }).start() : z2 || (z2 = true, it("settle")));
      })), rt(), (function() {
        if (V && C && (V.addEventListener("click", At, { passive: false }), document.addEventListener("mousemove", st), !j2)) {
          let t2 = true, e3 = null;
          j2 = new ResizeObserver((() => {
            if (t2) {
              if (C) {
                const t3 = C.getBoundingClientRect();
                Q = t3.height, U = t3.width;
              }
              t2 = false;
            } else e3 || (e3 = requestAnimationFrame((() => {
              !(function() {
                if (1 !== P || !C) return;
                const t3 = K.length;
                wt(), rt();
                const e4 = C.getBoundingClientRect(), n3 = e4.height, i3 = e4.width;
                t3 > 1 && (q2 && Math.abs(n3 - Q) < 0.5 || !q2 && Math.abs(i3 - U) < 0.5) || (Q = n3, U = i3, q2 && !n3 || !q2 && !i3 || V && C && (t3 === K.length && (null == M2 ? void 0 : M2.isPointerDown()) || (tt("dragFree") && (D2 || F > N && F < _2) ? (at(), Vt()) : Ot(k2, { transition: false }))));
              })(), e3 = null;
            })));
          })), j2.observe(C);
        }
  ...
  function rt() {
    false === tt("gestures") ? M2 && (M2.destroy(), M2 = void 0) : M2 || (function() {
      ...
      !M2 && false !== t2 && C && (M2 = f(C, t2).on("start", ((t3) => {
        var e2, n2;
        if (!S) return;
        const { srcEvent: o2 } = t3;
        q2 && e$6(o2) && !n$8(o2.target) && m(o2), S.pause(), S.getCurrentVelocities().pos = 0;
        const s2 = null === (e2 = K[k2]) || void 0 === e2 ? void 0 : e2.slides[0];
        s2 && W.has(s2.index) && s2.el && (F = s2.offset || 0, F += ((function(t4) {
          const e3 = window.getComputedStyle(t4), n3 = new DOMMatrixReadOnly(e3.transform);
          return { width: n3.m41 || 0, height: n3.m42 || 0 };
        })(s2.el)[I2] || 0) * ($2 && !q2 ? 1 : -1)), St(), D2 || (F < N || F > _2) && S.spring({ clamp: true, mass: 1, tension: 500, friction: 25, velocity: (null === (n2 = S.getCurrentVelocities()) || void 0 === n2 ? void 0 : n2.pos) || 0, restDelta: 1, restSpeed: 1 }).from({ pos: F }).to({ pos: t$6(N, F, _2) }).start();
      })).on("move", ((t3) => {
        var e2, n2;
        const { srcEvent: o2, axis: s2 } = t3, r2 = o2.target;
        if (s2 || (m(o2), o2.stopPropagation(), o2.stopImmediatePropagation()), ("y" === s2 && q2 || "x" === s2 && !q2) && (m(o2), o2.stopPropagation()), !s2) return;
        const { deltaX: l2, deltaY: a2 } = t3;
        if (!S) return;
        if (e$6(o2) && (null === (e2 = o2.touches) || void 0 === e2 ? void 0 : e2.length) > 1) return;
        if ("y" === s2 && !q2 || "x" === s2 && q2) return;
        if (r2 && n$8(r2) && ("x" !== s2 || q2)) return;
        const c2 = $2 && !q2 ? 1 : -1;
        let d2 = q2 ? a2 : l2, u2 = (null == S ? void 0 : S.isRunning()) ? S.getEndValues().pos : F, f2 = 1;
        D2 || (u2 <= N && d2 * c2 < 0 ? (f2 = Math.max(0.01, 1 - (Math.abs(1 / vt() * Math.abs(u2 - N)) || 0)), f2 *= 0.2) : u2 >= _2 && d2 * c2 > 0 && (f2 = Math.max(0.01, 1 - (Math.abs(1 / vt() * Math.abs(u2 - _2)) || 0)), f2 *= 0.2)), u2 += d2 * f2 * c2, S.spring({ clamp: true, mass: 1, tension: 700, friction: 25, velocity: (null === (n2 = S.getCurrentVelocities()) || void 0 === n2 ? void 0 : n2.pos) || 0, restDelta: 1, restSpeed: 1 }).from({ pos: F }).to({ pos: u2 }).start();
      })).on("panstart", ((t3) => {
        (null == t3 ? void 0 : t3.axis) === (q2 ? "y" : "x") && s$7(C, "is-dragging");
      })).on("panend", (() => {
        s$6(C, "is-dragging");
      })).on("end", ((t3) => {
        var e2, n2;
        ...
        q2 && e$6(o2) && !t3.axis && At(o2);
        const f2 = K.length, v2 = tt("dragFree");
        if (!f2) return;
        const g2 = tt("vertical") ? l2 : r2;
        let m2 = (null == S ? void 0 : S.isRunning()) ? S.getEndValues().pos : F;
        const h2 = $2 && !q2 ? 1 : -1;
        if (u2 || (m2 += g2 * (v2 ? 5 : 1) * h2), !D2 && (g2 * h2 <= 0 && m2 < N || g2 * h2 >= 0 && m2 > _2)) {
          let t4 = 0;
          return Math.abs(g2) > 0 && (t4 = 2 * Math.abs(g2), t4 = Math.min(0.3 * vt(), t4)), m2 = t$6(N + -1 * t4, m2, _2 + t4), void S.spring({ clamp: true, mass: 1, tension: 380, friction: 25, velocity: -1 * g2, restDelta: 1, restSpeed: 1 }).from({ pos: F }).to({ pos: m2 }).start();
        }
        if (v2 || (null === (e2 = R2.Autoscroll) || void 0 === e2 ? void 0 : e2.isEnabled())) return void (Math.abs(g2) > 10 ? S.spring({ clamp: true, mass: 1, tension: 150, friction: 25, velocity: -1 * g2, restDelta: 1, restSpeed: 1 }).from({ pos: F }).to({ pos: m2 }).start() : S.isRunning() || z2 || (z2 = true, it("settle")));
        if (!v2 && !(null === (n2 = R2.Autoscroll) || void 0 === n2 ? void 0 : n2.isEnabled()) && (!t3.offsetX && !t3.offsetY || "y" === s2 && !q2 || "x" === s2 && q2)) return void Ot(k2, { transition: "tween" });
        let b2 = ut(m2);
        Math.abs(g2) > 10 && b2 === k2 && (b2 += g2 > 0 ? $2 && !q2 ? 1 : -1 : $2 && !q2 ? -1 : 1), Ot(b2, { transition: "tween", tween: { velocity: -1 * g2 } });
      })).init());
  ...
  function at() {
    ...
    t2 !== k2 && (A = k2, k2 = t2, Tt(), ct(), dt(), it("change", k2, A));
  }
  function ct() {
    var t2, e2;
    if (!V) return;
    for (const t3 of V.querySelectorAll("[data-carousel-index]")) t3.innerHTML = k2 + "";
    for (const t3 of V.querySelectorAll("[data-carousel-page]")) t3.innerHTML = k2 + 1 + "";
    for (const t3 of V.querySelectorAll("[data-carousel-pages]")) t3.innerHTML = K.length + "";
    for (const e3 of V.querySelectorAll("[data-carousel-go-to]")) {
    ...
    for (const t3 of V.querySelectorAll("[data-carousel-go-prev]")) t3.toggleAttribute("aria-disabled", !Ht()), Ht() ? t3.removeAttribute("tabindex") : t3.setAttribute("tabindex", "-1");
    for (const t3 of V.querySelectorAll("[data-carousel-go-next]")) t3.toggleAttribute("aria-disabled", !Dt()), Dt() ? t3.removeAttribute("tabindex") : t3.setAttribute("tabindex", "-1");
    let n2 = false;
    const i2 = null === (e2 = K[k2]) || void 0 === e2 ? void 0 : e2.slides[0];
    i2 && (i2.downloadSrc || "image" === i2.type && i2.src) && (n2 = true);
    for (const t3 of V.querySelectorAll("[data-carousel-download]")) t3.toggleAttribute("aria-disabled", !n2);
  }
  function dt(t2) {
    var e2;
  ...
  function bt(t2) {
    let e2 = t2.el;
    if (!t2 || !e2) return;
    const n2 = t2.html ? t2.html instanceof HTMLElement ? t2.html : e$9(t2.html) : void 0;
  ...
  function wt() {
    ...
    const r2 = tt("classes");
    if (s$5(V, r2.isLTR, !$2), s$5(V, r2.isRTL, $2), s$5(V, r2.isHorizontal, !q2), s$5(V, r2.isVertical, q2), s$5(V, r2.hasAdaptiveHeight, tt("adaptiveHeight")), !vt()) return;
    ...
    if ((function() {
    ...
    })(), N = (null === (i2 = K[0]) || void 0 === i2 ? void 0 : i2.pos) || 0, _2 = (null === (o2 = K[K.length - 1]) || void 0 === o2 ? void 0 : o2.pos) || 0, 0 === P) !(function() {
      var t3;
      A = void 0, k2 = tt("initialPage");
      ...
      const t3 = (null == S ? void 0 : S.isRunning()) ? S.getEndValues().pos : F;
      (t3 < N || t3 > _2) && (B2 = (null === (s2 = K[k2 || 0]) || void 0 === s2 ? void 0 : s2.pos) || 0, F = t$6(N, F, _2));
    }
    it("refresh"), ct();
  }
  function Mt(t2) {
  ...
  function jt(t2) {
    var e2;
    "f-" === (null === (e2 = t2.animationName) || void 0 === e2 ? void 0 : e2.substring(0, 2)) && (Mt(t2.target), W.size || (s$6(V, "in-transition"), !z2 && Math.abs($t.getPosition(true) - B2) < 0.5 && (z2 = true, it("settle"))), Vt());
  }
  function At(t2) {
    var e2;
  ...
  function Tt(t2) {
    ...
    if (s2 && s2 instanceof HTMLElement) {
      ...
      if (t$7(o2) && (s2.innerHTML = et(o2 + "")), o2 instanceof HTMLElement) {
    ...
    !r2 && o2 instanceof HTMLElement && o2.classList.contains("f-caption") && (r2 = o2), r2 || (r2 = document.createElement("div"), s$7(r2, "f-caption"), t$7(o2) ? r2.innerHTML = et(o2 + "") : o2 instanceof HTMLElement && (o2.parentElement && (o2 = o2.cloneNode(true)), r2.append(o2)));
  ...
  function Ot(e2, i2 = {}) {
    ...
    if ((function(t2, e3) {
      var i3, o3, s2, r3;
      if (!(V && S && e3 && t$7(e3) && "tween" !== e3)) return false;
      ...
      z2 = false, S.pause(), St(), s$7(V, "in-transition"), F = B2 = m2;
      const h2 = Et(f3), b2 = Et(p3);
      return at(), h2 && (W.add(v3), h2.style.transform = "", h2.addEventListener("animationend", jt), s$6(h2, O2.classes.isSelected), h2.inert = false, s$7(h2, `f-${e3}Out to-${u3 > 0 ? "next" : "prev"}`)), b2 && (W.add(g2), b2.style.transform = "", b2.addEventListener("animationend", jt), s$7(b2, O2.classes.isSelected), b2.inert = false, s$7(b2, `f-${e3}In from-${u3 > 0 ? "prev" : "next"}`)), Vt(), true;
    })(e2, l2)) return;
    ...
    if (Math.abs(B2 - p2) < 1) return F = B2, k2 !== e2 && (Tt(), A = k2, k2 = e2, ct(), dt(), it("change", k2, A)), Vt(), void (z2 || (z2 = true, it("settle")));
    if (S.pause(), St(), D2) {
    ...
    false !== l2 && t$5(u2) ? S.spring(r$3({}, O2.tween, u2)).from({ pos: F }).to({ pos: B2 }).start() : (F = B2, at(), Vt(), z2 || (z2 = true, it("settle")));
  }
  function Rt(t2) {
    var e2;
    let n2 = F;
  ...
  function Vt() {
    ...
    C && l2 && (C.style.height = `${l2}px`), [...e$4(C, `.${O2.classes.slide}`)].forEach(((t3) => {
      ...
      if (n3.isVirtual && !i3 && !o2) return void yt(n3);
  ...
  function Ct() {
    null == V || V.removeEventListener("click", At), W.clear(), document.removeEventListener("mousemove", st), null == j2 || j2.disconnect(), j2 = void 0;
    for (const t2 of X) {
      let n2 = t2.el;
      n2 && n$9(n2) && (t2.state = void 0, Lt(t2), Pt(t2), t2.isVirtual ? (yt(t2), t2.el = void 0) : (Mt(n2), n2.style.transform = "", C && !C.contains(n2) && C.appendChild(n2)));
    }
    for (const t2 of Object.values(R2)) null == t2 || t2.destroy();
    R2 = {}, null == M2 || M2.destroy(), M2 = void 0, null == S || S.destroy(), S = void 0;
    for (const [t2, e2] of Object.entries(O2.classes || {})) "container" !== t2 && s$6(V, e2);
    s$6(C, "is-draggable");
  }
  function Ht() {
    return D2 || k2 > 0;
  ...
  const $t = { add: function(t2, e2) {
    var n2, i2;
    let o2 = F;
    const s2 = k2, r2 = pt(), l2 = (null == S ? void 0 : S.isRunning()) ? S.getEndValues().pos : F, a2 = r2 && Math.floor((l2 - ((null === (n2 = K[0]) || void 0 === n2 ? void 0 : n2.pos) || 0)) / r2) || 0;
    return mt(t2, e2), lt(G), wt(), S && r2 && (s2 === k2 && (o2 -= a2 * r2), B2 = (null === (i2 = K[k2 || 0]) || void 0 === i2 ? void 0 : i2.pos) || 0, o2 === B2 ? F = B2 : S.spring({ clamp: true, mass: 1, tension: 300, friction: 25, restDelta: 1, restSpeed: 1 }).from({ pos: o2 }).to({ pos: B2 }).start()), Vt(), $t;
  }, canGoPrev: Ht, canGoNext: Dt, destroy: function() {
    return it("destroy"), window.removeEventListener("resize", ot), Ct(), nt.clear(), V = null, K = [], X = [], O2 = Object.assign({}, h), R2 = {}, Y = [], L = void 0, G = "*", P = 2, $t;
  }, emit: it, filter: function(t2 = "*") {
    return lt(t2), wt(), Vt(), it("filter", t2), $t;
    ...
    return 0 !== P && (Ct(), P = 0), V = g, T = x2, window.removeEventListener("resize", ot), T.breakpoints && window.addEventListener("resize", ot), ot(), $t;
  }, isInfinite: function() {
    return D2;
    ...
    const e2 = X[t2];
    return e2 && (it("removeSlide", e2), e2.el && (Mt(e2.el), e2.el.remove(), e2.el = void 0), X.splice(t2, 1), lt(G), wt(), Vt()), $t;
    ...
    if (!e2 || n2) return $t;
    const i2 = tt("spinnerTpl"), o2 = e$9(i2);
...
/*! License details at fancyapps.com/license */
const s$3 = { showLoading: true, preload: 1 }, n$4 = "is-lazyloading", o$3 = "is-lazyloaded", l$4 = "has-lazyerror", i$4 = () => {
  let i2;
  function d2() {
      ...
      if (g) {
        if (y2 && g) {
          ...
          d2().showLoading && (null == i2 || i2.showLoading(t2)), r4.addEventListener("load", (() => {
            null == i2 || i2.hideLoading(t2), s$6(r4, l$4), r4 instanceof HTMLImageElement ? r4.decode().then((() => {
              s$6(r4, n$4), s$7(r4, o$3);
            })) : (s$6(r4, n$4), s$7(r4, o$3)), m3 || null == i2 || i2.emit("lazyLoad:loaded", t2, r4, g);
          })), r4.addEventListener("error", (() => {
            null == i2 || i2.hideLoading(t2), s$6(r4, n$4), s$7(r4, l$4), m3 || null == i2 || i2.emit("lazyLoad:error", t2, r4, g);
...
/*! License details at fancyapps.com/license */
const r$2 = 'tabindex="-1" width="24" height="24" viewBox="0 0 24 24"', i$3 = { prevTpl: `<svg ${r$2}><path d="M15 3l-9 9 9 9"></path></svg>`, nextTpl: `<svg ${r$2}><path d="M9 3l9 9-9 9"></path></svg>` }, s$2 = () => {
  let r2, s2, l2;
  function a2() {
  ...
  function u2(e2) {
    ...
    return i2 && s$7(i2, a2()[`${e2}Class`]), i2;
  }
  function g() {
    var t2;
  ...
  function c2() {
    r2 && false !== r2.getOptions().Arrows && r2.getPages().length > 1 ? (!(function() {
      ...
      t2 && (s2 || (s2 = u2("prev"), s2 && t2.insertAdjacentElement("beforebegin", s2)), l2 || (l2 = u2("next"), l2 && t2.insertAdjacentElement("afterend", l2)), s$5(r2.getContainer(), "has-arrows", !(!s2 && !l2)));
...
const c$1 = () => {
  ...
  function T() {
    ...
    for (const n2 of e2) t2.push({ index: n2.index, html: C(n2) });
    return t2;
  }
  function C(t2) {
  ...
  function E2() {
    ...
    for (const e2 of T()) {
      const n2 = e2.html || "";
      "string" == typeof n2 && (t2 += `<div index="${e2.index}" class="f-thumbs__slide">${n2}</div>`);
    }
  ...
  function P() {
    ...
    d2 = a$2(f2, o2, { Sync: i$5, Lazyload: i$4 }), d2.on("ready", (() => {
      s$7(f2, "is-syncing"), null == c2 || c2.emit("thumbs:ready"), x2() && (null == c2 || c2.on("render", A));
    })), d2.on("destroy", (() => {
    ...
    })), s$7(c2.getContainer(), "has-thumbs"), D2();
  }
  function w2() {
    y2() && b2("showOnStart") && (L(), E2());
  }
  function j2() {
    var t2;
    y2() && (P(), null == c2 || c2.on("addSlide", _2), null == c2 || c2.on("removeSlide", O2), null == c2 || c2.on("click", z2), null == c2 || c2.on("refresh", I2), null === (t2 = null == c2 ? void 0 : c2.getGestures()) || void 0 === t2 || t2.on("start", $2), q2());
  }
  function $2() {
    var t2, e2;
    p2 = true;
  ...
  function A() {
    var t2, e2;
    null == f2 || f2.classList.toggle("is-syncing", false === (null == c2 ? void 0 : c2.hasNavigated()) || (null === (t2 = null == c2 ? void 0 : c2.getTween()) || void 0 === t2 ? void 0 : t2.isRunning())), D2(), (null === (e2 = null == c2 ? void 0 : c2.getGestures()) || void 0 === e2 ? void 0 : e2.isPointerDown()) && (function() {
      if (!x2()) return;
      if (!c2 || !d2) return;
      if (!p2) return;
  ...
  function _2(t2, e2) {
    if (d2) d2.add({ html: C(e2) }, e2.index);
    else if (m2) {
      const t3 = e$9(`<div index="${e2.index}" class="f-thumbs__slide">${C(e2)}</div>`);
      if (t3) {
        m2.append(t3);
  ...
  function z2(t2, e2) {
    const n2 = e2.target;
    n2 && !e2.defaultPrevented && "toggle" === n2.dataset.thumbsAction && (f2 || (L(true), E2(), P()), f2 && f2.classList.toggle("is-hidden"));
  }
  function I2() {
    q2();
  }
  function q2() {
    if (!c2 || !m2 || !S()) return;
    const t2 = c2.getPageIndex();
    m2.querySelectorAll(".is-selected").forEach(((t3) => {
      t3.classList.remove("is-selected");
    }));
    const e2 = m2.querySelector(`[index="${t2}"]`);
    if (e2) {
      e2.classList.add("is-selected");
      const t3 = m2.getBoundingClientRect(), n2 = e2.getBoundingClientRect(), o2 = e2.offsetTop - m2.offsetTop - 0.5 * t3.height + 0.5 * n2.height, i2 = e2.scrollLeft - m2.scrollLeft - 0.5 * t3.width + 0.5 * n2.width;
      m2.scrollTo({ top: o2, left: i2, behavior: "smooth" });
    }
  }
  function D2() {
    if (!x2()) return;
  ...
  return { init: function(t2, e2) {
    a$2 = e2, c2 = t2, c2.on("ready", j2), c2.on("initSlides", w2), c2.on("change", M2);
  }, destroy: function() {
    var t2, e2;
    S() && (null == c2 || c2.emit("thumbs:destroy")), null == c2 || c2.off("ready", j2), null == c2 || c2.off("initSlides", w2), null == c2 || c2.off("change", M2), null == c2 || c2.off("render", A), null == c2 || c2.off("addSlide", _2), null == c2 || c2.off("click", z2), null == c2 || c2.off("refresh", I2), null === (t2 = null == c2 ? void 0 : c2.getGestures()) || void 0 === t2 || t2.off("start", $2), null === (e2 = null == c2 ? void 0 : c2.getContainer()) || void 0 === e2 || e2.classList.remove("has-thumbs"), c2 = void 0, null == d2 || d2.destroy(), d2 = void 0, null == f2 || f2.remove(), f2 = void 0;
...
const l = () => {
  ...
  e && setTimeout((() => {
    n = true, u(), n = false, window.addEventListener("hashchange", a, false);
  }), 300);
}, d = () => {
  let t2, e2 = "auto", s2 = "";
  function u2() {
    ...
    const d2 = t2.getCarousel();
    if (!d2) return;
    const { urlHash: f2, urlSlug: g } = l(), h2 = t2.getSlide();
    if (!h2) return;
    let w2 = h2.slug || h2.fancybox || "", p2 = parseInt(h2.index + "", 10) + 1;
    if (!w2) return;
    let y2 = h2.slug ? `#${h2.slug}` : `#${w2}-${p2}`;
    if (((null === (i2 = null === (r2 = t2.getCarousel()) || void 0 === r2 ? void 0 : r2.getPages()) || void 0 === i2 ? void 0 : i2.length) || 0) < 2 && (y2 = `#${w2}`), f2 !== y2 && (s2 = f2), history.scrollRestoration && (e2 = history.scrollRestoration, history.scrollRestoration = "manual"), d2.on("change", a2), n) return void (null === (u3 = t2.getOptions().sync) || void 0 === u3 || u3.goTo((null === (c3 = t2.getCarousel()) || void 0 === c3 ? void 0 : c3.getPageIndex()) || 0));
    const v2 = w2 !== g;
    try {
      window.history[v2 ? "pushState" : "replaceState"]({}, document.title, window.location.pathname + window.location.search + y2);
    } catch (t3) {
    }
    v2 && (o$1 = true);
  }
  ...
  return { init: function(e3) {
    t2 = e3, t2.on("ready", u2), t2.on("close", c2);
  }, destroy: function() {
    null == t2 || t2.off("ready", u2), null == t2 || t2.off("close", c2);
    const n2 = null == t2 ? void 0 : t2.getCarousel();
    n2 && n2.off("change", a2), t2 = void 0, history.scrollRestoration && e2 && (history.scrollRestoration = e2);
  } };
};
d.startFromUrl = u, d.setup = function(n2) {
...
const D = "with-fancybox", B = () => {
  ...
  function ne(t2 = [], n2 = {}) {
    ...
    if (a2 && a2.destroy(), H.set(K, Oe), te("init"), (function() {
      ...
      } }, Fullscreen: { el: T }, Toolbar: { absolute: true, items: { counter: { tpl: '<div class="f-counter"><span data-fancybox-page></span>/<span data-fancybox-pages></span></div>' } }, display: { left: ["counter"], right: ["toggleFull", "autoplay", "fullscreen", "thumbs", "close"] } }, Video: { autoplay: true }, Thumbs: { minCount: 2, Carousel: { classes: { container: "fancybox__thumbs" } } }, classes: { container: "fancybox__carousel", viewport: "fancybox__viewport", slide: "fancybox__slide" }, spinnerTpl: '<div class="f-spinner" data-fancybox-close></div>', dragFree: false, slidesPerPage: 1, plugins: { Sync: i$5, Arrows: s$2, Lazyload: i$4, Zoomable: s$4, Html: i$2, Video: l$2, Autoplay: n$3, Fullscreen: l$1, Thumbs: c$1, Toolbar: r$1 } }, J("Carousel") || {}, { slides: X, enabled: true, initialPage: J("startIndex") || 0, l10n: J("l10n") });
  ...
  function Me(e2, t2) {
    ...
    if (B2 && i2 && s2 && l2 && r3) {
      ...
      if (J("zoomEffect") && 1 === i2.state && (e3 = we(i2)), e3) {
        ...
        l2.on("refresh", (() => {
          t3();
        })), r3.easing(c$3.Easings.EaseOut).duration(350).from(Object.assign({}, l2.getTransform())).to(Object.assign(Object.assign({}, y$1), e3)).start(), (null == s2 ? void 0 : s2.getAnimations()) && (s2.style.animationPlayState = "paused", requestAnimationFrame((() => {
          t3();
        })));
      }
    }
...
const q = { Plugins: { Hash: d }, version: "6.1.2", openers: /* @__PURE__ */ new Map(), bind: function(e2, n2, o2) {
  if (!e$3()) return;
  ...
  if (t$7(e2) ? (s2 = e2, "object" == typeof n2 && (r2 = n2 || {})) : e2 instanceof Element && (i2 = e2, t$7(n2) && (s2 = n2), "object" == typeof o2 && (r2 = o2 || {})), !(i2 && i2 instanceof Element && s2)) return;
...
//# sourceMappingURL=vendor.bdtwPW46.js.map
