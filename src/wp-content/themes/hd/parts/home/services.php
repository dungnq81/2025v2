		...
		<ul class="tabs flex flex-nowrap pb-3 lg:pb-0 lg:justify-center gap-4 mt-16 xl:px-20 lg:mb-8 lg:gap-8 snap-x snap-mandatory overflow-x-auto" data-tabs id="services-tabs-<?=$id?>">
			...
			<li class="tabs-title snap-start">
                <a class="p-6 h-full flex items-center gap-4 c-light-button rounded-md hover:text-[#000] dark:hover:text-white" href="#marketing-online" title="Marketing Online">
                    ...
                    <h3 class="uppercase font-bold whitespace-nowrap p-fs-clamp-[16,20]">Marketing Online</h3>
                </a>
            </li>
			<li class="tabs-title snap-start">
                <a class="p-6 h-full flex items-center gap-4 c-light-button rounded-md hover:text-[#000] dark:hover:text-white" href="#nhan-dang-thuong-hieu" title="Nhận dạng thương hiệu">
                    ...
                    <h3 class="uppercase font-bold whitespace-nowrap p-fs-clamp-[16,20]">Nhận dạng thương hiệu</h3>
                </a>
            </li>
		</ul>
		<div class="tabs-content pt-12 lg:pt-24 lg:pb-12 xl:px-20" data-tabs-content="services-tabs-<?=$id?>">
			<div class="tabs-panel is-active" id="thiet-ke-website">
                <div class="flex flex-col md:flex-row gap-10 lg:gap-20 items-center">
                    ...
                    if ( ! empty( $bg00['img'] ) ) :
                    ?>
                    <div class="sm:w-full lg:w-1/3 max-w-2xl text-center -mx-3 sm:mx-0">
                    ...
                    <div class="w-full lg:w-2/3 max-w-2xl">
                        ...
                        <ul class="flex flex-col gap-5 mt-8">
                            <li class="flex items-baseline gap-3 md:gap-4 group">
                                <svg class="top-[7px] c-hover relative w-6 h-6 text-2 group-hover:text-1" aria-hidden="true"><use href="#icon-check-circle-outline"></use></svg>
                                <a class="uppercase font-bold text-[15px] hover:text-[#000] dark:hover:text-white" href="#" title="Website theo yêu cầu">Website theo yêu cầu</a>
                            </li>
                            <li class="flex items-baseline gap-3 md:gap-4 group">
                                <svg class="top-[7px] c-hover relative w-6 h-6 text-2 group-hover:text-1" aria-hidden="true"><use href="#icon-check-circle-outline"></use></svg>
                                <a class="uppercase font-bold text-[15px] hover:text-[#000] dark:hover:text-white" href="#" title="Website doanh nghiệp">Website doanh nghiệp</a>
                            </li>
                            <li class="flex items-baseline gap-3 md:gap-4 group">
                                <svg class="top-[7px] c-hover relative w-6 h-6 text-2 group-hover:text-1" aria-hidden="true"><use href="#icon-check-circle-outline"></use></svg>
                                <a class="uppercase font-bold text-[15px] hover:text-[#000] dark:hover:text-white" href="#" title="Website bán hàng">Website bán hàng</a>
                            </li>
                            <li class="flex items-baseline gap-3 md:gap-4 group">
                                <svg class="top-[7px] c-hover relative w-6 h-6 text-2 group-hover:text-1" aria-hidden="true"><use href="#icon-check-circle-outline"></use></svg>
                                <a class="uppercase font-bold text-[15px] hover:text-[#000] dark:hover:text-white" href="#" title="Website bất động sản">Website bất động sản</a>
                            </li>
                        </ul>
                    ...
                    <div class="w-full lg:w-2/3 max-w-2xl">
                        ...
                        <ul class="flex flex-col gap-5 mt-8">
                            <li class="flex items-baseline gap-4 group">
                                <svg class="top-[7px] c-hover relative w-6 h-6 text-2 group-hover:text-1" aria-hidden="true"><use href="#icon-check-circle-outline"></use></svg>
                                <a href="#" class="uppercase font-bold text-[15px] hover:text-[#000] dark:hover:text-white" title="Website theo yêu cầu">Dịch vụ SEO tổng thể</a>
                            </li>
                            <li class="flex items-baseline gap-4 group">
                                <svg class="top-[7px] c-hover relative w-6 h-6 text-2 group-hover:text-1" aria-hidden="true"><use href="#icon-check-circle-outline"></use></svg>
                                <a href="#" class="uppercase font-bold text-[15px] hover:text-[#000] dark:hover:text-white" title="Website doanh nghiệp">ADS GOOGLE - FACEBOOK</a>
                            </li>
                            <li class="flex items-baseline gap-4 group">
                                <svg class="top-[7px] c-hover relative w-6 h-6 text-2 group-hover:text-1" aria-hidden="true"><use href="#icon-check-circle-outline"></use></svg>
                                <a href="#" class="uppercase font-bold text-[15px] hover:text-[#000] dark:hover:text-white" title="Website bán hàng">CHĂM SÓC WEBSITE - FANPAGE</a>
                            </li>
                            <li class="flex items-baseline gap-4 group">
                                <svg class="top-[7px] c-hover relative w-6 h-6 text-2 group-hover:text-1" aria-hidden="true"><use href="#icon-check-circle-outline"></use></svg>
                                <a href="#" class="uppercase font-bold text-[15px] hover:text-[#000] dark:hover:text-white" title="Website bất động sản">SÁNG TẠO NỘI DUNG CHUẨN SEO</a>
                            </li>
                        </ul>
                        <a class="text-sm pt-12 inline-flex items-center gap-2 text-1" href="#" title="Xem thêm">
                            Xem thêm
                ...
                <div class="flex flex-col md:flex-row gap-10 lg:gap-20 items-center">
                    ...
                    <div class="w-full lg:w-2/3 max-w-2xl">
                        ...
                        <ul class="flex flex-col gap-5 mt-8">
                            <li class="flex items-baseline gap-4 group">
                                <svg class="top-[7px] c-hover relative w-6 h-6 text-2 group-hover:text-1" aria-hidden="true"><use href="#icon-check-circle-outline"></use></svg>
                                <a class="uppercase font-bold text-[15px] hover:text-[#000] dark:hover:text-white" href="#" title="Website theo yêu cầu">THIẾT KẾ LOGO</a>
                            </li>
                            <li class="flex items-baseline gap-4 group">
                                <svg class="top-[7px] c-hover relative w-6 h-6 text-2 group-hover:text-1" aria-hidden="true"><use href="#icon-check-circle-outline"></use></svg>
                                <a class="uppercase font-bold text-[15px] hover:text-[#000] dark:hover:text-white" href="#" title="Website doanh nghiệp">THIẾT KẾ NAME CARD</a>
                            </li>
                            <li class="flex items-baseline gap-4 group">
                                <svg class="top-[7px] c-hover relative w-6 h-6 text-2 group-hover:text-1" aria-hidden="true"><use href="#icon-check-circle-outline"></use></svg>
                                <a class="uppercase font-bold text-[15px] hover:text-[#000] dark:hover:text-white" href="#" title="Website bán hàng">CATELOGUE</a>
                            </li>
                            <li class="flex items-baseline gap-4 group">
                                <svg class="top-[7px] c-hover relative w-6 h-6 text-2 group-hover:text-1" aria-hidden="true"><use href="#icon-check-circle-outline"></use></svg>
                                <a class="uppercase font-bold text-[15px] hover:text-[#000] dark:hover:text-white" href="#" title="Website bất động sản">PROFILE</a>
                            </li>
                        </ul>
                        <a class="text-sm pt-12 inline-flex items-center gap-2 text-1" href="#" title="Xem thêm">
                            Xem thêm
