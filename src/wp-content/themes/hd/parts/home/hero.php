...
<section id="section-<?= $id ?>" class="section section-hero py-24">
	<div class="u-container grid pt-6 lg:gap-12 xl:gap-0 lg:grid-cols-12">
		<div class="mr-auto place-self-center lg:col-span-7">
            ...
            <?= $desc ? '<p class="max-w-2xl mb-9 p-fs-clamp-[16,18]">' . $desc . '</p>' : '' ?>

            <?php if ( $button_1 || $button_2 ) :

                $content_1 = \HD_Helper::ACFLinkLabel( $button_1 );
                $content_1 .= '<svg class="w-5 h-5 ml-2 -mr-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 12H5m14 0l-4 4m4-4l-4-4"/></svg>';
