            ...
            <div class="w-full lg:w-1/4 max-w-xl">
                <ul class="tabs flex flex-col gap-4 mt-15" data-tabs id="services-extra-tabs-<?=$id?>">
                    <li class="tabs-title is-active">
                        <a href="#seo" class="px-6 py-2 h-full flex items-center gap-4 c-light-button c-hover rounded-md hover:text-[#000] dark:hover:text-white" aria-selected="true" title="">
                    ...
                    <li class="tabs-title">
                        <a href="#app" class="px-6 py-2 h-full flex items-center gap-4 c-light-button c-hover rounded-md hover:text-[#000] dark:hover:text-white" aria-selected="true" title="">
                    ...
                    <li class="tabs-title">
                        <a href="#google" class="px-6 py-2 h-full flex items-center gap-4 c-light-button c-hover rounded-md hover:text-[#000] dark:hover:text-white" aria-selected="true" title="">
                    ...
                    <li class="tabs-title">
                        <a href="#facebook" class="px-6 py-2 h-full flex items-center gap-4 c-light-button c-hover rounded-md hover:text-[#000] dark:hover:text-white" aria-selected="true" title="">
                    ...
                    <li class="tabs-title">
                        <a href="#care" class="px-6 py-2 h-full flex items-center gap-4 c-light-button c-hover rounded-md hover:text-[#000] dark:hover:text-white" aria-selected="true" title="">
                    ...
                    <li class="tabs-title">
                        <a href="#fanpage" class="px-6 py-2 h-full flex items-center gap-4 c-light-button c-hover rounded-md hover:text-[#000] dark:hover:text-white" aria-selected="true" title="">
                    ...
                    <li class="tabs-title">
                        <a href="#pagespeed" class="px-6 py-2 h-full flex items-center gap-4 c-light-button c-hover rounded-md hover:text-[#000] dark:hover:text-white" aria-selected="true" title="">
                    ...
                    <li class="tabs-title">
                        <a href="#domain" class="px-6 py-2 h-full flex items-center gap-4 c-light-button c-hover rounded-md hover:text-[#000] dark:hover:text-white" aria-selected="true" title="">
                    ...
                    <li class="tabs-title">
                        <a href="#hosting-gia-re" class="px-6 py-2 h-full flex items-center gap-4 c-light-button c-hover rounded-md hover:text-[#000] dark:hover:text-white" aria-selected="true" title="">
                    ...
                    <li class="tabs-title">
                        <a href="#email-doanh-nghiep" class="px-6 py-2 h-full flex items-center gap-4 c-light-button c-hover rounded-md hover:text-[#000] dark:hover:text-white" aria-selected="true" title="">
            ...
            <div class="w-full lg:w-3/4">
                <div class="tabs-content mt-15" data-tabs-content="services-extra-tabs-<?=$id?>">
                    <div class="tabs-panel pt-4 is-active" id="seo">
                        <div class="max-w-3xl">
                            <p class="h3 text-balance font-bold mb-6 text-[#000] dark:text-white">Dịch vụ SEO tổng thể</p>
