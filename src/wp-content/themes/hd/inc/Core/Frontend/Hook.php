...
final class Hook {
	...
	private function init(): void {
		...
		add_action( 'enqueue_assets_template_page_home', static function () {
			...
			\HD_Asset::enqueueStyle( 'home-css', ASSETS_URL . 'css/home-css.css', [ 'index-css' ], $version );
			\HD_Asset::enqueueScript( 'home-js', ASSETS_URL . 'js/home.js', [ 'index-js' ], $version, true, [ 'module', 'defer' ] );
		} );
	}
        ...
        <div id="masthead" class="masthead">
            <div class="container gap fluid flex flex-x">
                ...
                <div class="masthead-content">
	                <?php \HD_Helper::blockTemplate( 'parts/blocks/language-menu' ); ?>
                    <?php echo \HD_Helper::doShortcode( 'off_canvas_button', [ 'hide_if_desktop' => 0 ] ); ?>
                </div>
            </div>
        </div>
		<?php
	...
	public function wp_footer_custom_js_action(): void {
		...
		if ( \HD_Helper::isPageTemplate( 'templates/template-page-home.php' ) ) :
        ?>
        <section class="loading-section">
            <div class="load-logo">
                <div class="load-logo-inner">
                    <div class="logo-wrapper am-logo">
                        <img src="<?= ASSETS_URL ?>img/AmConcept-Am.svg" alt="Logo" />
                    </div>
                    <div class="logo-wrapper concept-logo">
                        <img src="<?= ASSETS_URL ?>img/AmConcept-Concept.svg" alt="AmConcept" />
                    </div>
                </div>
            </div>
        </section>
