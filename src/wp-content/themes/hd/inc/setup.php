 ...
 *
 * Handles theme support declarations, menu registration,
 * image sizes, and other setup-related configurations.
 *
 * @author Gaudev
 */
...
//			'contact'     => __( 'Contacts', TEXT_DOMAIN ),
		...
		'social_follows_links'    => [
			'facebook'  => [
				...
				'icon'        => Helper::svg( 'facebook' ),
				'placeholder' => 'https://www.facebook.com',
				'url'         => '',
			],
			'instagram' => [
				'name'        => __( 'Instagram', TEXT_DOMAIN ),
				'icon'        => Helper::svg( 'instagram' ),
				'placeholder' => 'https://www.instagram.com',
				'url'         => '',
			],
			'youtube'   => [
				'name'        => __( 'Youtube', TEXT_DOMAIN ),
				'icon'        => Helper::svg( 'youtube' ),
