...
final class WooCommerce {
	...
	public function enqueueAssets(): void {
		\HD_Asset::enqueueStyle( 'hdwc-css', ASSETS_URL . 'css/woocommerce-css.css', [ 'index-css' ], \HD_Helper::version() );
		\HD_Asset::enqueueScript( 'hdwc-js', ASSETS_URL . 'js/woocommerce.js', [ 'jquery-core', 'index-js' ], \HD_Helper::version(), true, [ 'module', 'defer' ] );
	}
