...
final class CustomScript {
	...
	public function __construct() {
		add_action( 'wp_head', [ $this, 'header_scripts' ], 99 ); // header scripts
		add_action( 'wp_body_open', [ $this, 'body_scripts_top' ], 99 ); // body scripts - TOP

		add_action( 'wp_footer', [ $this, 'footer_scripts' ], 99 ); // footer scripts
		add_action( 'wp_footer', [ $this, 'body_scripts_bottom' ], 99 ); // body scripts - BOTTOM
	}
	 ...
	 * Body scripts - TOP
	 */
	public function body_scripts_top(): void {
	 ...
	 * Body scripts - BOTTOM
	 */
	public function body_scripts_bottom(): void {
