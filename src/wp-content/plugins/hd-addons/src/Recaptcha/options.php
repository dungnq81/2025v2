...
<div class="container flex flex-x gap sm-up-1 lg-up-2">
    ...
    <div class="cell section section-checkbox">
        <label class="heading" for="recaptcha_global"><?php _e( 'reCAPTCHA globally', ADDONS_TEXTDOMAIN ); ?></label>
        ...
        <div class="option">
            <div class="controls">
                <div class="select_wrapper">
                    <select multiple class="select select2-ips" name="recaptcha_allowlist_ips[]" id="recaptcha_allowlist_ips">
						<?php
